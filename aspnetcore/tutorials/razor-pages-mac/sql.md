...
> <span data-ttu-id="745ad-103">[上一步：新增模型](xref:tutorials/razor-pages-mac/model)
> [下一步：更新頁面](xref:tutorials/razor-pages-mac/da1)</span><span class="sxs-lookup"><span data-stu-id="745ad-103">[Previous: Adding a model](xref:tutorials/razor-pages-mac/model)
