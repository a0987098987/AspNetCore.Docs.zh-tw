<span data-ttu-id="11f53-101">執行下列 .NET Core CLI 命令：</span><span class="sxs-lookup"><span data-stu-id="11f53-101">Run the following .NET Core CLI commands:</span></span>
