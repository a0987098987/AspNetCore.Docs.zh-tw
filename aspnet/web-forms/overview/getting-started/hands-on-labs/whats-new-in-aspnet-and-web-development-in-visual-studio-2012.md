...
4. <span data-ttu-id="9b42c-155">按一下**摺疊**(![摺疊](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image6.png)) 和**展開**(![展開](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image7.png)) 按鈕位於左邊界的文字。</span><span class="sxs-lookup"><span data-stu-id="9b42c-155">Click the **Collapse** (![collapse](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image6.png) ) and **Expand** (![expand](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image7.png) ) buttons located on the left margin of the text.</span></span> <span data-ttu-id="9b42c-156">請注意，您現在可以隱藏您不使用具有更清楚地檢視的樣式。</span><span class="sxs-lookup"><span data-stu-id="9b42c-156">Notice that you can now hide the styles you don't use to have a cleaner view.</span></span>
    ...
    <span data-ttu-id="9b42c-157">![摺疊的 CSS 類別](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image8.png "摺疊的 CSS 類別")</span><span class="sxs-lookup"><span data-stu-id="9b42c-157">![Collapsing CSS classes](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image8.png "Collapsing CSS classes")</span></span>
...
7. <span data-ttu-id="9b42c-169">內部**.main div**類別中，尋找資料指標的結尾**框線： 0px;**按**Enter**顯示 IntelliSense 清單。</span><span class="sxs-lookup"><span data-stu-id="9b42c-169">Inside **.main div** class, locate the cursor at the end of **border: 0px;** and press **Enter** to display the IntelliSense list.</span></span> <span data-ttu-id="9b42c-170">開始輸入**頂端**，並注意當您輸入要篩選清單的方式。</span><span class="sxs-lookup"><span data-stu-id="9b42c-170">Start typing **top** and notice how the list is filtered as you type.</span></span> <span data-ttu-id="9b42c-171">清單會顯示包含的項目**頂端**在這個字的任何部分 (在舊版的 Visual Studio 中，由項目篩選清單，*開始*具有該詞彙)。</span><span class="sxs-lookup"><span data-stu-id="9b42c-171">The list will display the elements that contain **top** at any part of the word (In prior versions of Visual Studio, the list is filtered by the items that *begin* with the term).</span></span>
    ...
    <span data-ttu-id="9b42c-173">*在 CSS 中的 IntelliSense 增強功能*</span><span class="sxs-lookup"><span data-stu-id="9b42c-173">*IntelliSense enhancements in CSS*</span></span>
...
3. <span data-ttu-id="9b42c-184">按**展開**(![com](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image14.png) ) 上顯示的色彩漸層，，然後拖曳以選取不同的色彩漸層的資料指標與色彩選擇器 按鈕。</span><span class="sxs-lookup"><span data-stu-id="9b42c-184">Press the **Expand** (![com](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image14.png) ) button on the color picker to display the color gradient, and then drag the gradient cursor to select a different color.</span></span> <span data-ttu-id="9b42c-185">在這之後，按一下 **滴管**按鈕，然後從畫面中選取任何色彩。</span><span class="sxs-lookup"><span data-stu-id="9b42c-185">After that, click the **Eyedropper** button and select any color from the screen.</span></span> <span data-ttu-id="9b42c-186">請注意，背景色彩值以動態方式變更您移動游標時。</span><span class="sxs-lookup"><span data-stu-id="9b42c-186">Notice that background color value changes dynamically while you move the cursor.</span></span>
    ...
    <span data-ttu-id="9b42c-188">*漸層色彩選擇器*</span><span class="sxs-lookup"><span data-stu-id="9b42c-188">*Color picker gradient*</span></span>
...
1. <span data-ttu-id="9b42c-197">在**Site.css**檔案中，找出**標頭**CSS 類別定義 (.header)，並將下列游標 **/\*框線 radius\* /**要加入新的程式碼片段的預留位置。</span><span class="sxs-lookup"><span data-stu-id="9b42c-197">In the **Site.css** file, locate the **header** CSS class definition (.header) and place the cursor below the **/\*border radius\*/** placeholder to add a new snippet.</span></span> <span data-ttu-id="9b42c-198">按**Enter**顯示 IntelliSense 清單和型別**radius**來篩選清單。</span><span class="sxs-lookup"><span data-stu-id="9b42c-198">Press **Enter** to display the IntelliSense list and type **radius** to filter the list.</span></span> <span data-ttu-id="9b42c-199">選取**框線 radius**從清單中按兩下，與選項，然後再按 **索引標籤**插入程式碼片段的索引鍵。</span><span class="sxs-lookup"><span data-stu-id="9b42c-199">Select the **border-radius** option from the list with a double click, and then press the **TAB** key to insert the snippet.</span></span> <span data-ttu-id="9b42c-200">然後，輸入在像素並按下的 radius 大小**Enter**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-200">Then, type a radius size in pixels and press **Enter**.</span></span> <span data-ttu-id="9b42c-201">例如，輸入**15px**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-201">For instance, type **15px**.</span></span>
    ...
    <span data-ttu-id="9b42c-203">![使用框線 radius 片段](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image17.png "使用框線 radius 程式碼片段")</span><span class="sxs-lookup"><span data-stu-id="9b42c-203">![Using a border-radius snippet](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image17.png "Using a border-radius snippet")</span></span>
...
7. <span data-ttu-id="9b42c-220">建立新的類別**div.images u l l i img:hover**下方**div.images u l l i m g**類別定義，並將放在括號內的資料指標**。**</span><span class="sxs-lookup"><span data-stu-id="9b42c-220">Create a new class **div.images ul li img:hover** below the **div.images ul li img** class definition and place the cursor inside the brackets **.**</span></span>
    ...
    <span data-ttu-id="9b42c-221">CSS</span><span class="sxs-lookup"><span data-stu-id="9b42c-221">CSS</span></span>
...
4. <span data-ttu-id="9b42c-250">Html 4.01 變更目標結構描述。</span><span class="sxs-lookup"><span data-stu-id="9b42c-250">Change the Target Schema to HTML 4.01.</span></span>
    ...
    <span data-ttu-id="9b42c-252">*在 HTML 原始檔編輯工具列中變更文件類型*</span><span class="sxs-lookup"><span data-stu-id="9b42c-252">*Changing Doctype in HTML Source Editing toolbar*</span></span>
...
1. <span data-ttu-id="9b42c-267">在**Default.aspx**頁面上，新增**H3**標題 （例如，Visual Studio 2012 岩石 ！） 的項目。</span><span class="sxs-lookup"><span data-stu-id="9b42c-267">On the **Default.aspx** page, add an **H3** element with a title (for example, Visual Studio 2012 Rocks!).</span></span>
...
2. <span data-ttu-id="9b42c-278">在**Default.aspx**頁面上，找出下 Web11 岩石游標!!</span><span class="sxs-lookup"><span data-stu-id="9b42c-278">In the **Default.aspx** page, locate the cursor under the Web11 Rocks!!</span></span> <span data-ttu-id="9b42c-279">標頭。</span><span class="sxs-lookup"><span data-stu-id="9b42c-279">Header.</span></span> <span data-ttu-id="9b42c-280">型別**音訊**按 TAB 鍵。</span><span class="sxs-lookup"><span data-stu-id="9b42c-280">Type **audio** and press the TAB key.</span></span>
    ...
    <span data-ttu-id="9b42c-284">*將 HTML5 的程式碼片段*</span><span class="sxs-lookup"><span data-stu-id="9b42c-284">*Inserting HTML5 Code Snippets*</span></span>
...
5. <span data-ttu-id="9b42c-291">現在，請嘗試以插入控制項中頁面的某些部分。</span><span class="sxs-lookup"><span data-stu-id="9b42c-291">Now, try to insert a control in some part of the page.</span></span> <span data-ttu-id="9b42c-292">例如，嘗試插入**GridView**控制項，而不是輸入，但 **&lt;Gri，**開始輸入 **&lt;GV**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-292">For example, try to insert a **GridView** control, but instead of typing **&lt;Gri,** start typing **&lt;GV**.</span></span> <span data-ttu-id="9b42c-293">請注意，IntelliSense 清單顯示**asp: GridView**控制項。</span><span class="sxs-lookup"><span data-stu-id="9b42c-293">Notice that the IntelliSense list shows the **asp:GridView** control.</span></span>
    ...
    <span data-ttu-id="9b42c-299">*插入 IntelliSense 清單和部分比對的 GridView*</span><span class="sxs-lookup"><span data-stu-id="9b42c-299">*Inserting a GridView with IntelliSense lists and partial matching*</span></span>
...
<span data-ttu-id="9b42c-329">在這項工作，您將使用新的擷取至使用者控制項內容的作業，從選取的程式碼中產生新的使用者控制項。</span><span class="sxs-lookup"><span data-stu-id="9b42c-329">In this task, you will use the new Extract to User Control contextual operation to generate a new user control from the selected code.</span></span>
...
<span data-ttu-id="9b42c-346">Visual Studio 已更新，讓程式碼模式，存取與組織承諾的 JavaScript 編輯器。</span><span class="sxs-lookup"><span data-stu-id="9b42c-346">Visual Studio has renewed the JavaScript editor with the promise to make the code mode accessible and organized.</span></span> <span data-ttu-id="9b42c-347">在 C# 或 VB 編輯器中已存在的許多 Visual Studio 功能現在都實作中的 JavaScript 編輯器： 移至定義、 自動縮排、 文件集和您在撰寫時的驗證。</span><span class="sxs-lookup"><span data-stu-id="9b42c-347">Many Visual Studio features that already existed in C# or VB editors are now implemented in the JavaScript editor: Go To Definition, automatic indentation, documentation and validation when you are writing.</span></span> <span data-ttu-id="9b42c-348">更新的 IntelliSense 清單將您手邊有 JavaScript 函式類別目錄。</span><span class="sxs-lookup"><span data-stu-id="9b42c-348">With the renewed IntelliSense list you will have the JavaScript function catalog at your fingertips.</span></span>
...
4. <span data-ttu-id="9b42c-390">檔案的最後一行，在寫入任何字串 like **&quot;測試&quot;** （加上引號，以指出它是以字串形式）。</span><span class="sxs-lookup"><span data-stu-id="9b42c-390">In the last line of the file, write any string like **&quot;test&quot;** (include the quotation marks to indicate it is as string).</span></span> <span data-ttu-id="9b42c-391">寫入期間來顯示 [IntelliSense] 清單中，選取字串旁的**修剪**選項。</span><span class="sxs-lookup"><span data-stu-id="9b42c-391">Write a period next to the string to display the IntelliSense list, and select the **trim** option.</span></span>
    ...
    <span data-ttu-id="9b42c-392">ECMAScript5 標準字串值和變數也會有定義，例如修剪、 大寫、 搜尋和取代字串方法。</span><span class="sxs-lookup"><span data-stu-id="9b42c-392">In ECMAScript5 standard, string values and variables also have string methods defined, like trim, uppercase, search and replace.</span></span>
...
<span data-ttu-id="9b42c-396">在這個工作中，您將探索在 JavaScript 中的 XML 文件的 Visual Studio 功能。</span><span class="sxs-lookup"><span data-stu-id="9b42c-396">In this task, you will explore Visual Studio features for XML documentation in JavaScript.</span></span> <span data-ttu-id="9b42c-397">您會看到 JavaScript IntelliSense 清單現在會顯示每個函式的 XML 文件。</span><span class="sxs-lookup"><span data-stu-id="9b42c-397">You will see the JavaScript IntelliSense list now shows the XML documentation of each function.</span></span> <span data-ttu-id="9b42c-398">此外，您會發現在 JavaScript 中的巡覽功能。</span><span class="sxs-lookup"><span data-stu-id="9b42c-398">Additionally, you will discover the navigation feature in JavaScript.</span></span>

1. <span data-ttu-id="9b42c-399">開啟**XMLDoc.js**檔案位於**指令碼/自訂**專案資料夾。</span><span class="sxs-lookup"><span data-stu-id="9b42c-399">Open **XMLDoc.js** file located in **Scripts/custom** project folder.</span></span> <span data-ttu-id="9b42c-400">此檔案包含 JavaScript 函式的每個 XML 文件。</span><span class="sxs-lookup"><span data-stu-id="9b42c-400">This file contains XML documentation on each of the JavaScript functions.</span></span>

    <span data-ttu-id="9b42c-401">![JavaScript XML 文件整合 intellisense](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image44.png "JavaScript XML 文件整合 intellisense")</span><span class="sxs-lookup"><span data-stu-id="9b42c-401">![JavaScript XML documentation integrated to IntelliSense](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image44.png "JavaScript XML documentation integrated to IntelliSense")</span></span>

    <span data-ttu-id="9b42c-402">*JavaScript XML 文件整合 intellisense*</span><span class="sxs-lookup"><span data-stu-id="9b42c-402">*JavaScript XML documentation integrated to IntelliSense*</span></span>
2. <span data-ttu-id="9b42c-403">下面**新增**函式在**XMLDoc.js**檔案中，建立新的函式，名為**測試**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-403">Below **add** function in **XMLDoc.js** file, create a new function named **test**.</span></span>
3. <span data-ttu-id="9b42c-404">在**測試**函式，呼叫**乘**接收兩個參數的函式。</span><span class="sxs-lookup"><span data-stu-id="9b42c-404">In the **test** function, call the **multiply** function that receives two parameters.</span></span> <span data-ttu-id="9b42c-405">請注意顯示工具提示方塊**乘**函式文件。</span><span class="sxs-lookup"><span data-stu-id="9b42c-405">Notice the tooltip box is showing the **multiply** function documentation.</span></span>

    [!code-javascript[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample9.js)]

    <span data-ttu-id="9b42c-406">![對於 JavaScript 函式的 XML 文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "JavaScript 函式的 XML 文件")</span><span class="sxs-lookup"><span data-stu-id="9b42c-406">![XML documentation for JavaScript functions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image45.png "XML documentation for JavaScript functions")</span></span>

    <span data-ttu-id="9b42c-407">*對於 JavaScript 函式的 XML 文件*</span><span class="sxs-lookup"><span data-stu-id="9b42c-407">*XML documentation for JavaScript functions*</span></span>
4. <span data-ttu-id="9b42c-408">完成的函式呼叫的陳述式和類型*點*開啟 IntelliSense 清單上傳回的值。</span><span class="sxs-lookup"><span data-stu-id="9b42c-408">Complete the function call statement and type a *dot* to open the IntelliSense list on the returned value.</span></span> <span data-ttu-id="9b42c-409">請注意，Visual Studio 會偵測**傳回**文件，視為數字的值中的值。</span><span class="sxs-lookup"><span data-stu-id="9b42c-409">Notice that Visual Studio is detecting the **return** value in the documentation, treating the value as a number.</span></span>

    <span data-ttu-id="9b42c-410">![傳回類型的 XML 文件](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "傳回類型的 XML 文件")</span><span class="sxs-lookup"><span data-stu-id="9b42c-410">![XML documentation for return types](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image46.png "XML documentation for return types")</span></span>

    <span data-ttu-id="9b42c-411">*傳回類型的 XML 文件*</span><span class="sxs-lookup"><span data-stu-id="9b42c-411">*XML documentation for return types*</span></span>
5. <span data-ttu-id="9b42c-412">現在，插入對加入函式的呼叫。</span><span class="sxs-lookup"><span data-stu-id="9b42c-412">Now, insert a call to add function.</span></span> <span data-ttu-id="9b42c-413">請注意 JavaScript 編輯器現在支援函式多載。</span><span class="sxs-lookup"><span data-stu-id="9b42c-413">Notice that the JavaScript editor now supports function overloads.</span></span> <span data-ttu-id="9b42c-414">當您撰寫函式名稱時，您可以選取任何可用的多載指定文件中。</span><span class="sxs-lookup"><span data-stu-id="9b42c-414">When you write a function name, you will be able to select any of the available overloads specified in the documentation.</span></span>

    <span data-ttu-id="9b42c-415">![XML 文件的多載](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "多載的 XML 文件")</span><span class="sxs-lookup"><span data-stu-id="9b42c-415">![XML documentation for overloads](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image47.png "XML documentation for overloads")</span></span>

    <span data-ttu-id="9b42c-416">*多載的 XML 文件*</span><span class="sxs-lookup"><span data-stu-id="9b42c-416">*XML documentation for overloads*</span></span>
6. <span data-ttu-id="9b42c-417">開啟**GotoDefinition.js**檔案，並尋找**$().html()**函式呼叫。</span><span class="sxs-lookup"><span data-stu-id="9b42c-417">Open **GotoDefinition.js** file and locate the **$().html()** function call.</span></span> <span data-ttu-id="9b42c-418">將游標置於**html**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-418">Locate the cursor on **html**.</span></span>
7. <span data-ttu-id="9b42c-419">按**F12**並巡覽至定義。</span><span class="sxs-lookup"><span data-stu-id="9b42c-419">Press **F12** and navigate to the definition.</span></span> <span data-ttu-id="9b42c-420">請注意，您現在可以存取，並瀏覽您的 JavaScript 程式碼，而不使用**尋找**工具。</span><span class="sxs-lookup"><span data-stu-id="9b42c-420">Notice you can now access and browse your JavaScript code without using the **Find** tool.</span></span>
8. <span data-ttu-id="9b42c-421">在底部的 程式碼檔案的簽章區塊之前的 jQuery 指令中找到資料指標。</span><span class="sxs-lookup"><span data-stu-id="9b42c-421">Locate the cursor on the jQuery instruction prior to the signature block at the bottom of the code file.</span></span> <span data-ttu-id="9b42c-422">按**F12**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-422">Press **F12**.</span></span> <span data-ttu-id="9b42c-423">您會瀏覽至 jQuery 程式庫檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-423">You will navigate to the jQuery library file.</span></span> <span data-ttu-id="9b42c-424">請注意，您也可以使用的 jQuery 檔案之間瀏覽**F12**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-424">Notice you can also navigate across the jQuery files using **F12**.</span></span>

    <span data-ttu-id="9b42c-425">![巡覽至 jQuery 定義](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "巡覽至 jQuery 定義")</span><span class="sxs-lookup"><span data-stu-id="9b42c-425">![Navigating to jQuery definitions](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image48.png "Navigating to jQuery definitions")</span></span>

    <span data-ttu-id="9b42c-426">*巡覽至 jQuery 定義*</span><span class="sxs-lookup"><span data-stu-id="9b42c-426">*Navigating to jQuery definitions*</span></span>

> [!NOTE]
> <span data-ttu-id="9b42c-427">確定 GotoDefinition.js 儲存檔案之前有沒有語法錯誤。</span><span class="sxs-lookup"><span data-stu-id="9b42c-427">Make sure that GotoDefinition.js has no syntax errors before saving the file.</span></span>


<a id="Exercise4"></a>

<a id="Exercise_4_Bundling_and_Minification"></a>
### <a name="exercise-4-bundling-and-minification"></a><span data-ttu-id="9b42c-428">練習 4： 組合和縮製</span><span class="sxs-lookup"><span data-stu-id="9b42c-428">Exercise 4: Bundling and Minification</span></span>

<span data-ttu-id="9b42c-429">多少次，您的網站，並包含一個以上的 JavaScript 或 CSS 檔案？</span><span class="sxs-lookup"><span data-stu-id="9b42c-429">How many times do your websites include more than one JavaScript or CSS file?</span></span> <span data-ttu-id="9b42c-430">這是很常見的案例，其中統合及縮製有助於減少檔案大小，並讓執行得更快的站台。</span><span class="sxs-lookup"><span data-stu-id="9b42c-430">This is a very common scenario where bundling and minification can help to reduce the file size and make the site perform faster.</span></span> <span data-ttu-id="9b42c-431">ASP.NET 4.5 的新功能將一組 JS 或 CSS 檔案封裝成單一元素，並縮短內容 （也就是移除不必要的空白，移除註解，減少識別項） 時，減少其大小。</span><span class="sxs-lookup"><span data-stu-id="9b42c-431">The new bundling feature in ASP.NET 4.5 packs a set of JS or CSS files into a single element, and reduces its size by minifying the content ( i.e. removing not required blank spaces, removing comments, reducing identifiers ).</span></span>

<span data-ttu-id="9b42c-432">統合及縮製 ASP.NET 4.5 中的被執行在執行階段，好讓處理程序可以識別出使用者代理程式 （例如 IE、 Mozilla 等等），並因此，將目標設為使用者瀏覽器 （比方說，移除項目是特定 Mozilla 改善壓縮當要求來自 IE）。</span><span class="sxs-lookup"><span data-stu-id="9b42c-432">Bundling and minification in ASP.NET 4.5 is performed at runtime, so that the process can identify the user agent (for example IE, Mozilla, etc), and thus, improve the compression by targeting the user browser (for instance, removing stuff that is Mozilla specific when the request comes from IE).</span></span>

<span data-ttu-id="9b42c-433">在此練習中，您將學習如何啟用和 ASP.NET 4.5 中使用不同類型的統合及縮製。</span><span class="sxs-lookup"><span data-stu-id="9b42c-433">In this exercise, you will learn how to enable and use the different types of bundling and minification in ASP.NET 4.5.</span></span>

<a id="Ex4Task1"></a>

<a id="Task_1_-_Installing_the_Bundling_and_Minification_Package_from_NuGet"></a>
#### <a name="task-1---installing-the-bundling-and-minification-package-from-nuget"></a><span data-ttu-id="9b42c-434">工作 1-安裝組合和縮製 NuGet 封裝</span><span class="sxs-lookup"><span data-stu-id="9b42c-434">Task 1 - Installing the Bundling and Minification Package from NuGet</span></span>

1. <span data-ttu-id="9b42c-435">如果尚未開啟，請啟動**Visual Studio**並開啟**WhatsNewASPNET.sln**方案位於**Source\WhatsNewASPNET**本實驗室的資料夾。</span><span class="sxs-lookup"><span data-stu-id="9b42c-435">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="9b42c-436">開啟 NuGet 封裝管理員主控台。</span><span class="sxs-lookup"><span data-stu-id="9b42c-436">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="9b42c-437">若要這樣做，請使用功能表**檢視** | **其他視窗** | **Package Manager Console**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-437">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>

    <span data-ttu-id="9b42c-438">![開啟 封裝管理員 file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "開啟封裝管理員主控台")</span><span class="sxs-lookup"><span data-stu-id="9b42c-438">![Opening the package manager file:///C:/Users/User/AppData/Local/Temp/Marker3744//media/44462/Multiple-Stylesheets-and-JavaScript-files-in-the-application.pngconsole](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image49.png "Opening the package manager console")</span></span>

    <span data-ttu-id="9b42c-439">*開啟 封裝管理員主控台*</span><span class="sxs-lookup"><span data-stu-id="9b42c-439">*Opening the package manager console*</span></span>
3. <span data-ttu-id="9b42c-440">在**Package Manager Console**類型**Install-package Microsoft.Web.Optimization**按**ENTER**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-440">In the **Package Manager Console,** type **Install-Package Microsoft.Web.Optimization** and press **ENTER**.</span></span>

<a id="Ex4Task2"></a>

<a id="Task_2_-_Default_Bundles"></a>
#### <a name="task-2---default-bundles"></a><span data-ttu-id="9b42c-441">工作 2-預設組合</span><span class="sxs-lookup"><span data-stu-id="9b42c-441">Task 2 - Default Bundles</span></span>

<span data-ttu-id="9b42c-442">使用統合及縮製的最簡單方式是啟用預設組合。</span><span class="sxs-lookup"><span data-stu-id="9b42c-442">The simplest way to use bundling and minification is to enable the default bundles.</span></span> <span data-ttu-id="9b42c-443">這個方法會使用慣例，讓您參考配套並縮短 JS 和 CSS 資料夾中的檔案版本。</span><span class="sxs-lookup"><span data-stu-id="9b42c-443">This method uses conventions to let you reference the bundled and minified version for the JS and CSS files in a folder.</span></span>

<span data-ttu-id="9b42c-444">在這項工作，您將學習如何啟用和參考配套並縮短 JS 和 CSS 檔案，並檢視所產生的輸出。</span><span class="sxs-lookup"><span data-stu-id="9b42c-444">In this task, you will learn how to enable and reference the bundled and minified JS and CSS files and view the resulting output.</span></span>

1. <span data-ttu-id="9b42c-445">如果尚未開啟，請啟動**Visual Studio**並開啟**WhatsNewASPNET.sln**方案位於**Source\WhatsNewASPNET**本實驗室的資料夾。</span><span class="sxs-lookup"><span data-stu-id="9b42c-445">If not already opened, start **Visual Studio** and open the **WhatsNewASPNET.sln** solution located in the **Source\WhatsNewASPNET** folder of this lab.</span></span>
2. <span data-ttu-id="9b42c-446">在**方案總管 中**，依序展開**樣式**， **Scripts\custom**和**Scripts\bundle**資料夾。</span><span class="sxs-lookup"><span data-stu-id="9b42c-446">In the **Solution Explorer**, expand the **Styles**, **Scripts\custom** and **Scripts\bundle** folders.</span></span>

    <span data-ttu-id="9b42c-447">請注意，應用程式使用多個 CSS 與 JS 檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-447">Notice that the application is using more than one CSS and JS file.</span></span>

    <span data-ttu-id="9b42c-448">![應用程式中的多個樣式表和 JavaScript 檔案](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "應用程式中的多個樣式表與 JavaScript 檔案")</span><span class="sxs-lookup"><span data-stu-id="9b42c-448">![Multiple Stylesheets and JavaScript files in the application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image50.png "Multiple Stylesheets and JavaScript files in the application")</span></span>

    <span data-ttu-id="9b42c-449">*應用程式中的多個樣式表和 JavaScript 檔案*</span><span class="sxs-lookup"><span data-stu-id="9b42c-449">*Multiple Stylesheets and JavaScript files in the application*</span></span>
3. <span data-ttu-id="9b42c-450">開啟**Global.asax.cs**檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-450">Open the **Global.asax.cs** file.</span></span>

    <span data-ttu-id="9b42c-451">請注意，新**Microsoft.Web.Optimization**命名空間已標記為註解檔案的開頭。</span><span class="sxs-lookup"><span data-stu-id="9b42c-451">Notice that the new **Microsoft.Web.Optimization** namespace is commented out at the beginning of the file.</span></span> <span data-ttu-id="9b42c-452">取消註解 using 指示詞包含統合及縮製的功能。</span><span class="sxs-lookup"><span data-stu-id="9b42c-452">Uncomment the using directive to include the bundling and minification features.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample10.cs)]
4. <span data-ttu-id="9b42c-453">找出**應用程式\_啟動**方法。</span><span class="sxs-lookup"><span data-stu-id="9b42c-453">Locate the **Application\_Start** method.</span></span>

    <span data-ttu-id="9b42c-454">在此方法中，請取消註解 EnableDefaultBundles 呼叫以下程式碼片段所示。</span><span class="sxs-lookup"><span data-stu-id="9b42c-454">In this method, uncomment the EnableDefaultBundles call as shown in the snippet below.</span></span> <span data-ttu-id="9b42c-455">這可讓我們來參考搭售的 CSS 資料夾中的檔案集合使用的路徑，該資料夾，再加上&quot;CSS&quot;或&quot;JS&quot;後置詞。</span><span class="sxs-lookup"><span data-stu-id="9b42c-455">This enables us to reference a bundled collection of CSS files in a folder by using the path to that folder, plus the &quot;CSS&quot; or the &quot;JS&quot; suffix.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample11.cs)]
5. <span data-ttu-id="9b42c-456">開啟**Optimization.aspx**檔案，並尋找的內容控制項**HeadContent**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-456">Open the **Optimization.aspx** file and locate the content control for **HeadContent**.</span></span>

    <span data-ttu-id="9b42c-457">請注意 CSS 檔案和 JS 檔案有一個參考的標記。</span><span class="sxs-lookup"><span data-stu-id="9b42c-457">Notice the CSS files and the JS files have a single referenced tag.</span></span>


    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample12.aspx)]

    > [!NOTE]
    > <span data-ttu-id="9b42c-458">此程式碼會用於示範用途。</span><span class="sxs-lookup"><span data-stu-id="9b42c-458">This code is for demo purposes.</span></span> <span data-ttu-id="9b42c-459">在理想情況下，您將會參考在 Site.Master 檔組合。</span><span class="sxs-lookup"><span data-stu-id="9b42c-459">Ideally, you will reference the bundles in the Site.Master file.</span></span> <span data-ttu-id="9b42c-460">在此範例程式碼中，您會發現，部分配套檔案所要參照的 Site.Master 檔中，進行多餘的這個最後一個參考。</span><span class="sxs-lookup"><span data-stu-id="9b42c-460">In this sample code, you will find that some of the bundled files are also being referenced by the Site.Master file, making this last reference redundant.</span></span>
6. <span data-ttu-id="9b42c-461">請注意，使用連結中的將慣例**href**屬性以取得所有 CSS 或 JS 檔案樣式和 Scripts\custom 資料夾分別。</span><span class="sxs-lookup"><span data-stu-id="9b42c-461">Notice that the links are using the bundling conventions in the **href** attribute to get all the CSS or JS files from the Styles and Scripts\custom folder respectively.</span></span>

    <span data-ttu-id="9b42c-462">您可以使用路徑**指令碼/自訂/JS**配套並縮短內的所有 JS 檔案，如下所示**指令碼/自訂**資料夾。</span><span class="sxs-lookup"><span data-stu-id="9b42c-462">You can use the path **Scripts/custom/JS** as shown below to bundle and minify all the JS files inside a **Scripts/custom** folder.</span></span> <span data-ttu-id="9b42c-463">這是預設組合的預設行為。</span><span class="sxs-lookup"><span data-stu-id="9b42c-463">This is the default behavior with the default bundles.</span></span>


    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample13.aspx)]
7. <span data-ttu-id="9b42c-464">開啟**Styles\Site.css**檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-464">Open the **Styles\Site.css** file.</span></span>

    <span data-ttu-id="9b42c-465">請注意，原始的 CSS 檔案包含縮排程式碼、 空格和增加檔案大小的註解。</span><span class="sxs-lookup"><span data-stu-id="9b42c-465">Notice that the original CSS file contains indented code, blank spaces and comments that enlarge the file.</span></span> <span data-ttu-id="9b42c-466">（也 JavaScript 檔案包含空格和註解）。</span><span class="sxs-lookup"><span data-stu-id="9b42c-466">(Also the JavaScript file contains blank spaces and comments).</span></span>

    <span data-ttu-id="9b42c-467">![其中一個原始 CSS 檔案中的指令碼資料夾](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "其中一個原始 CSS 檔案中的指令碼資料夾")</span><span class="sxs-lookup"><span data-stu-id="9b42c-467">![One of the original CSS files in the Scripts folder](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image51.png "One of the original CSS files in the Scripts folder")</span></span>

    <span data-ttu-id="9b42c-468">*其中一個原始 CSS 檔案中的指令碼資料夾*</span><span class="sxs-lookup"><span data-stu-id="9b42c-468">*One of the original CSS files in the Scripts folder*</span></span>
8. <span data-ttu-id="9b42c-469">按**F5**執行應用程式，並瀏覽到**最佳化**頁面。</span><span class="sxs-lookup"><span data-stu-id="9b42c-469">Press **F5** to run the application and navigate to the **Optimization** page.</span></span>
9. <span data-ttu-id="9b42c-470">按一下**CSS 配套**連結來下載並開啟檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-470">Click on the **CSS Bundle** link to download and open the file.</span></span>

    <span data-ttu-id="9b42c-471">簽出縮短配套的檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-471">Check out the minified bundled file.</span></span> <span data-ttu-id="9b42c-472">您會發現的所有空格、 註解和縮排的字元都已經都移除，正在產生較小的檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-472">You will notice that all the blank spaces, comments and indentation characters have been removed, generating a smaller file.</span></span>

    <span data-ttu-id="9b42c-473">![配套 CSS 檔案](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "配套 CSS 檔案")</span><span class="sxs-lookup"><span data-stu-id="9b42c-473">![Bundled CSS files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image52.png "Bundled CSS files")</span></span>

    <span data-ttu-id="9b42c-474">*配套的 CSS 檔案*</span><span class="sxs-lookup"><span data-stu-id="9b42c-474">*Bundled CSS files*</span></span>
10. <span data-ttu-id="9b42c-475">現在按一下**JS 組合**開啟配套的 JavaScript 檔案連結。</span><span class="sxs-lookup"><span data-stu-id="9b42c-475">Now click the **JS Bundle** link to open the JavaScript bundled file.</span></span> <span data-ttu-id="9b42c-476">您可以放心地忽略警告 [總管]。</span><span class="sxs-lookup"><span data-stu-id="9b42c-476">You can safely disregard the explorer warning.</span></span> <span data-ttu-id="9b42c-477">請注意下的 JavaScript 檔案**自訂**資料夾也會搭配並縮短。</span><span class="sxs-lookup"><span data-stu-id="9b42c-477">Notice the JavaScript files under the **custom** folder are also bundled and minified.</span></span>

    <span data-ttu-id="9b42c-478">![配套的 JavaScript 檔案](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "配套 JavaScript 檔案")</span><span class="sxs-lookup"><span data-stu-id="9b42c-478">![Bundled JavaScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image53.png "Bundled JavaScript files")</span></span>

    <span data-ttu-id="9b42c-479">*配套的 JavaScript 檔案*</span><span class="sxs-lookup"><span data-stu-id="9b42c-479">*Bundled JavaScript files*</span></span>

    <span data-ttu-id="9b42c-480">啟用壓縮 CSS 或 JS 檔案是較為複雜舊版 ASP.NET 中。</span><span class="sxs-lookup"><span data-stu-id="9b42c-480">Enabling compression for CSS or JS files was much more complicated in previous ASP.NET version.</span></span> <span data-ttu-id="9b42c-481">現在，如您所見，您只需要加入這一行中的*Global.asax*檔案以便結合在一起，並再參考配套的檔案從您的網站。</span><span class="sxs-lookup"><span data-stu-id="9b42c-481">Now, as you have seen, you just need to add one line in the *Global.asax* file to enable bundling, and then reference the bundled files from your site.</span></span>

<a id="Ex4Task3"></a>

<a id="Task_3_-_Static_Bundles"></a>
#### <a name="task-3---static-bundles"></a><span data-ttu-id="9b42c-482">工作 3-靜態組合</span><span class="sxs-lookup"><span data-stu-id="9b42c-482">Task 3 - Static Bundles</span></span>

<span data-ttu-id="9b42c-483">靜態套件組合方法可讓您自訂的組合、 參考和縮製方法將使用的檔案集。</span><span class="sxs-lookup"><span data-stu-id="9b42c-483">The static bundle approach allows you to customize the set of files to bundle, the reference and the minification method that will be used.</span></span>

<span data-ttu-id="9b42c-484">在這項工作，您將設定來定義一組特定的配套並縮短檔案的靜態套件組合。</span><span class="sxs-lookup"><span data-stu-id="9b42c-484">In this task, you will configure a static bundle to define a specific set of files to bundle and minify.</span></span>

1. <span data-ttu-id="9b42c-485">關閉瀏覽器。</span><span class="sxs-lookup"><span data-stu-id="9b42c-485">Close the browser.</span></span>
2. <span data-ttu-id="9b42c-486">開啟**Global.asax.cs**檔案，並尋找**應用程式\_啟動**方法。</span><span class="sxs-lookup"><span data-stu-id="9b42c-486">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
3. <span data-ttu-id="9b42c-487">取消註解的靜態配套程式碼，如下列程式碼所示。</span><span class="sxs-lookup"><span data-stu-id="9b42c-487">Uncomment the static bundle code as shown in the code below.</span></span>

    <span data-ttu-id="9b42c-488">您正在定義會參考具有靜態配套&quot; **~/StaticBundle** &quot;虛擬路徑及使用**JsMinify**具有所有指定檔案的縮製的**AddFile**方法。</span><span class="sxs-lookup"><span data-stu-id="9b42c-488">You are defining a static bundle that will be referenced with the &quot;**~/StaticBundle**&quot; virtual path and use **JsMinify** for minification of all the specified files with the **AddFile** method.</span></span> <span data-ttu-id="9b42c-489">最後，您要在其中加入靜態套件組合， **BundleTable**及啟用它。</span><span class="sxs-lookup"><span data-stu-id="9b42c-489">Finally, you are adding the static bundle to the **BundleTable** and enabling it.</span></span>

    <span data-ttu-id="9b42c-490">請注意，檔案不在相同的位置。這是另一個預設結合在一起的優勢。</span><span class="sxs-lookup"><span data-stu-id="9b42c-490">Notice that the files are not located in the same place; this is another advantage over the default bundling.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample14.cs)]
4. <span data-ttu-id="9b42c-491">開啟**Optimization.aspx**檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-491">Open the **Optimization.aspx** file.</span></span>

    <span data-ttu-id="9b42c-492">請注意，連結至**靜態 JS 組合**正在使用您已經宣告 Global.asax.cs 檔案中設定靜態套件組合時的路徑： **/StaticBundle**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-492">Notice that the link to **Static JS Bundle** is using the path you have declared when you configured the static bundle in the Global.asax.cs file: **/StaticBundle**.</span></span>


    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample15.aspx)]
5. <span data-ttu-id="9b42c-493">按**F5**執行應用程式，並瀏覽至**最佳化**頁面。</span><span class="sxs-lookup"><span data-stu-id="9b42c-493">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
6. <span data-ttu-id="9b42c-494">按一下**靜態 JS 組合**連結來開啟檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-494">Click on the **Static JS Bundle** link to open the file.</span></span>

    <span data-ttu-id="9b42c-495">請注意縮短配套 JavaScript 檔案已設定靜態組合檔案的路徑下的所有 JavaScript 檔案的輸出&quot;/StaticBundle&quot;。</span><span class="sxs-lookup"><span data-stu-id="9b42c-495">Notice that the minified bundled JavaScript file is the output for all the JavaScript files configured in the static bundle file under the path &quot;/StaticBundle&quot;.</span></span>

    <span data-ttu-id="9b42c-496">![靜態的 JavaScript 檔案配套](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "靜態 JavaScript 檔案的套件組合")</span><span class="sxs-lookup"><span data-stu-id="9b42c-496">![Static JavaScript files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image54.png "Static JavaScript files bundle")</span></span>

    <span data-ttu-id="9b42c-497">*靜態的 JavaScript 檔案的配套*</span><span class="sxs-lookup"><span data-stu-id="9b42c-497">*Static JavaScript files bundle*</span></span>
7. <span data-ttu-id="9b42c-498">關閉瀏覽器，並返回 Visual Studio。</span><span class="sxs-lookup"><span data-stu-id="9b42c-498">Close the browser and return to Visual Studio.</span></span>

<a id="Ex4Task4"></a>

<a id="Task_4_-_Dynamic_Folder_Bundles"></a>
#### <a name="task-4---dynamic-folder-bundles"></a><span data-ttu-id="9b42c-499">工作 4-動態資料夾組合</span><span class="sxs-lookup"><span data-stu-id="9b42c-499">Task 4 - Dynamic Folder Bundles</span></span>

<span data-ttu-id="9b42c-500">在這項工作，您將學習如何設定動態資料夾組合。</span><span class="sxs-lookup"><span data-stu-id="9b42c-500">In this task, you will learn how to configure dynamic folder bundles.</span></span> <span data-ttu-id="9b42c-501">動態結合在一起的功能是可以包含靜態 JavaScript，以及其他檔案中會編譯成 JavaScript 的語言，因此，需要一些處理，結合在一起會在執行之前。</span><span class="sxs-lookup"><span data-stu-id="9b42c-501">The power of dynamic bundling is that you can include static JavaScript, as well as other files in languages that compiles into JavaScript, and thus, require some processing before the bundling is executed.</span></span>

<span data-ttu-id="9b42c-502">在此範例中，您將學習如何使用**DynamicFolderBundle**類別來建立動態套件組合 CofeeScript 中撰寫的檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-502">In this example, you will learn how to use the **DynamicFolderBundle** class to create a dynamic bundle for files written in CofeeScript.</span></span> <span data-ttu-id="9b42c-503">CofeeScript 是編譯成 JavaScript，並提供更簡單的語法撰寫 JavaScript 程式碼、 增強 JavaScript 的保持簡潔和可讀性的程式設計語言。</span><span class="sxs-lookup"><span data-stu-id="9b42c-503">CofeeScript is a programming language that compiles into JavaScript and provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability.</span></span>

1. <span data-ttu-id="9b42c-504">開啟**Global.asax.cs**檔案，並尋找**應用程式\_啟動**方法。</span><span class="sxs-lookup"><span data-stu-id="9b42c-504">Open the **Global.asax.cs** file and locate the **Application\_Start** method.</span></span>
2. <span data-ttu-id="9b42c-505">取消註解的動態套件組合程式碼，如下列程式碼所示。</span><span class="sxs-lookup"><span data-stu-id="9b42c-505">Uncomment the dynamic bundle code as shown in the code below.</span></span>

    <span data-ttu-id="9b42c-506">您會定義將會使用動態資料夾組合**CoffeeMinify**只會套用到具有檔案的自訂縮製處理器&quot; **.coffee** &quot;延伸模組 (CoffeeScript 檔案）。</span><span class="sxs-lookup"><span data-stu-id="9b42c-506">You are defining a dynamic folder bundle that will use the **CoffeeMinify** custom minification processor that will only apply to the files with the &quot;**.coffee**&quot; extension (CoffeeScript files).</span></span> <span data-ttu-id="9b42c-507">請注意，您可以選取要像配套資料夾內檔案使用搜尋模式 '\*.coffee'。</span><span class="sxs-lookup"><span data-stu-id="9b42c-507">Notice that you can use a search pattern to select the files to bundle within a folder, like '\*.coffee'.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample16.cs)]
3. <span data-ttu-id="9b42c-508">開啟 NuGet 封裝管理員主控台。</span><span class="sxs-lookup"><span data-stu-id="9b42c-508">Open the NuGet Package Manager Console.</span></span> <span data-ttu-id="9b42c-509">若要這樣做，請使用功能表**檢視** | **其他視窗** | **Package Manager Console**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-509">To do this, use the menu **View** | **Other Windows** | **Package Manager Console**.</span></span>
4. <span data-ttu-id="9b42c-510">在**Package Manager Console**類型**Install-package CoffeeSharp**按**ENTER**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-510">In the **Package Manager Console,** type **Install-Package CoffeeSharp** and press **ENTER**.</span></span>
5. <span data-ttu-id="9b42c-511">按一下**顯示所有檔案**按鈕**方案總管 中**視窗</span><span class="sxs-lookup"><span data-stu-id="9b42c-511">Click the **Show All Files** button in the **Solution Explorer** window</span></span>

    <span data-ttu-id="9b42c-512">![顯示所有檔案](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "都顯示所有檔案")</span><span class="sxs-lookup"><span data-stu-id="9b42c-512">![Showing all files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image55.png "Showing all files")</span></span>

    <span data-ttu-id="9b42c-513">*顯示所有檔案*</span><span class="sxs-lookup"><span data-stu-id="9b42c-513">*Showing all files*</span></span>
6. <span data-ttu-id="9b42c-514">以滑鼠右鍵按一下**CoffeeMinify.cs**檔案**方案總管 中**選取**加入至專案**</span><span class="sxs-lookup"><span data-stu-id="9b42c-514">Right click the **CoffeeMinify.cs** file in the **Solution Explorer** and select **Include in Project**</span></span>

    <span data-ttu-id="9b42c-515">![在專案中包含 CoffeeMinify.cs 檔案](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "CoffeeMinify.cs 檔案包含在專案")</span><span class="sxs-lookup"><span data-stu-id="9b42c-515">![Include the CoffeeMinify.cs file in the project](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image56.png "Include the CoffeeMinify.cs file in the project")</span></span>

    <span data-ttu-id="9b42c-516">*在專案中包含 CoffeeMinify.cs 檔案*</span><span class="sxs-lookup"><span data-stu-id="9b42c-516">*Include the CoffeeMinify.cs file in the project*</span></span>
7. <span data-ttu-id="9b42c-517">開啟**CoffeeMinify.cs**檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-517">Open the **CoffeeMinify.cs** file.</span></span>

    <span data-ttu-id="9b42c-518">此類別繼承自 JsMinify 来縮短 CoffeeScript 程式碼編譯所產生的 JavaScript 輸出中。</span><span class="sxs-lookup"><span data-stu-id="9b42c-518">This class inherits from JsMinify to minify the JavaScript output resulting from the CoffeeScript code compilation.</span></span> <span data-ttu-id="9b42c-519">它會呼叫 CoffeeScript 編譯器在第一次，產生的 JavaScript 程式碼，然後它傳送它至 JsMinify.Process 方法，以縮短產生的程式碼。</span><span class="sxs-lookup"><span data-stu-id="9b42c-519">It calls the CoffeeScript compiler to generate the JavaScript code first, and then it sends it to the JsMinify.Process method to minify the resulting code.</span></span>


    [!code-csharp[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample17.cs)]
8. <span data-ttu-id="9b42c-520">開啟**Script1.coffee**和**Script2.coffee**檔案從**指令碼/配套**資料夾。</span><span class="sxs-lookup"><span data-stu-id="9b42c-520">Open the **Script1.coffee** and **Script2.coffee** files from the **Scripts/bundle** folder.</span></span>

    <span data-ttu-id="9b42c-521">這些檔案會包含 CoffeScript 程式碼結合在一起以 CoffeeMinify 類別的執行時編譯。</span><span class="sxs-lookup"><span data-stu-id="9b42c-521">These files will include the CoffeScript code to be compiled while performing the bundling with the CoffeeMinify class.</span></span>

    <span data-ttu-id="9b42c-522">為了簡單起見，提供的 CoffeeScript 檔案只包含 CoffeeScript 範例程式碼。</span><span class="sxs-lookup"><span data-stu-id="9b42c-522">For simplicity purposes, the CoffeeScript files provided are only including CoffeeScript sample code.</span></span> <span data-ttu-id="9b42c-523">註解會排除 JsMinify 程序。</span><span class="sxs-lookup"><span data-stu-id="9b42c-523">The comments are excluded by the JsMinify process.</span></span>

    <span data-ttu-id="9b42c-524">![CoffeeScript 檔案](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "CoffeeScript 檔案")</span><span class="sxs-lookup"><span data-stu-id="9b42c-524">![CoffeeScript files](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image57.png "CoffeeScript files")</span></span>

    <span data-ttu-id="9b42c-525">*CoffeeScript 檔案*</span><span class="sxs-lookup"><span data-stu-id="9b42c-525">*CoffeeScript files*</span></span>

    > [!NOTE]
    > <span data-ttu-id="9b42c-526">[CofeeScript](https://github.com/jashkenas/coffeescript/)撰寫 JavaScript 程式碼、 增強 JavaScript 的保持簡潔和可讀性，以及加入其他功能，例如陣列理解與模式比對會提供更簡單的語法。</span><span class="sxs-lookup"><span data-stu-id="9b42c-526">[CofeeScript](https://github.com/jashkenas/coffeescript/) provides a simpler syntax for writing JavaScript code, enhancing JavaScript's brevity and readability, as well as adding other features like array comprehension and pattern matching.</span></span>
9. <span data-ttu-id="9b42c-527">開啟**Optimization.aspx**檔案，並尋找配套連結。</span><span class="sxs-lookup"><span data-stu-id="9b42c-527">Open the **Optimization.aspx** file and locate the bundle links.</span></span>

    <span data-ttu-id="9b42c-528">請注意，連結至**動態 JS 組合**參考**指令碼/配套**資料夾使用**/咖啡**您設定動態資料夾組合的後置詞。</span><span class="sxs-lookup"><span data-stu-id="9b42c-528">Notice that the link to **Dynamic JS Bundle** is referencing the **Scripts/bundle** folder by using the **/Coffee** suffix you configured for the dynamic folder bundle.</span></span>


    [!code-aspx[Main](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/samples/sample18.aspx)]
10. <span data-ttu-id="9b42c-529">按**F5**執行應用程式，並瀏覽至**最佳化**頁面。</span><span class="sxs-lookup"><span data-stu-id="9b42c-529">Press **F5** to run the application, and then navigate to the **Optimization** page.</span></span>
11. <span data-ttu-id="9b42c-530">按一下**動態 JS 組合**連結來開啟產生的檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-530">Click on the **Dynamic JS Bundle** link to open the generated file.</span></span>

    <span data-ttu-id="9b42c-531">請注意，此組合中所包含的內容僅包含**.coffee**檔案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-531">Notice that the content that was included in this bundle only contains **.coffee** files.</span></span> <span data-ttu-id="9b42c-532">您也可以查看 CoffeeScript 程式碼編譯至 JavaScript，並已移除的標記為註解的線條。</span><span class="sxs-lookup"><span data-stu-id="9b42c-532">You can also see that the CoffeeScript code was compiled to JavaScript and the commented-out lines has been removed.</span></span>

    <span data-ttu-id="9b42c-533">![動態 JS 檔案配套](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "動態 JS 檔案配套")</span><span class="sxs-lookup"><span data-stu-id="9b42c-533">![Dynamic JS files bundle](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image58.png "Dynamic JS files bundle")</span></span>

    <span data-ttu-id="9b42c-534">*動態 JS 檔案配套*</span><span class="sxs-lookup"><span data-stu-id="9b42c-534">*Dynamic JS files bundle*</span></span>

> [!NOTE]
> <span data-ttu-id="9b42c-535">此外，您可以部署此應用程式以 Windows Azure Web Sites 下列[附錄 b： 發佈 ASP.NET MVC 4 應用程式使用 Web Deploy](#AppendixB)。</span><span class="sxs-lookup"><span data-stu-id="9b42c-535">Additionally, you can deploy this application to Windows Azure Web Sites following [Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy](#AppendixB).</span></span>


<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="9b42c-536">總結</span><span class="sxs-lookup"><span data-stu-id="9b42c-536">Summary</span></span>

<span data-ttu-id="9b42c-537">這個實驗室可協助您了解新 ASP.NET 和 Visual Studio 2012 中的 Web 開發是什麼，以及如何利用 Visual Studio 2012 中的各種增強功能。</span><span class="sxs-lookup"><span data-stu-id="9b42c-537">This lab helps you to understand what New in ASP.NET and Web Development in Visual Studio 2012 is and how to take advantage of the variety of enhancements in Visual Studio 2012.</span></span>

<span data-ttu-id="9b42c-538">藉由完成這個實際操作實驗室，您已學會如何在 Visual Studio 2012 編輯器中使用的新功能與增強功能，CSS、 JavaScript 和 HTML。</span><span class="sxs-lookup"><span data-stu-id="9b42c-538">By completing this Hands-On Lab, you have learnt how to use the new features and improvements in Visual Studio 2012 Editors for CSS, JavaScript and HTML.</span></span> <span data-ttu-id="9b42c-539">此外，您已學會如何 Visual Studio 2012 實作內建統合及縮製的。</span><span class="sxs-lookup"><span data-stu-id="9b42c-539">In addition, you have learnt how Visual Studio 2012 implements built-in bundling and minification.</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="9b42c-540">附錄 a： 安裝 Visual Studio Express 2012 for Web</span><span class="sxs-lookup"><span data-stu-id="9b42c-540">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="9b42c-541">您可以安裝**Microsoft Visual Studio Express 2012 for Web**或另一個&quot;Express&quot;版本使用 **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)** .</span><span class="sxs-lookup"><span data-stu-id="9b42c-541">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="9b42c-542">下列指示將引導您逐步完成安裝所需*Visual studio Express 2012 for Web*使用*Microsoft Web Platform Installer*。</span><span class="sxs-lookup"><span data-stu-id="9b42c-542">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="9b42c-543">移至[ [https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169)。</span><span class="sxs-lookup"><span data-stu-id="9b42c-543">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="9b42c-544">或者，如果您已安裝 Web Platform Installer，您可以開啟它，並搜尋產品&quot; *Visual Studio Express 2012 for Web 與 Windows Azure SDK*&quot;。</span><span class="sxs-lookup"><span data-stu-id="9b42c-544">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;*Visual Studio Express 2012 for Web with Windows Azure SDK*&quot;.</span></span>
2. <span data-ttu-id="9b42c-545">按一下**立即安裝**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-545">Click on **Install Now**.</span></span> <span data-ttu-id="9b42c-546">如果您不需要**Web Platform Installer**您會重新導向至下載並安裝第一次。</span><span class="sxs-lookup"><span data-stu-id="9b42c-546">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="9b42c-547">一次**Web Platform Installer**開啟時，按一下 **安裝**，啟動安裝程式。</span><span class="sxs-lookup"><span data-stu-id="9b42c-547">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="9b42c-548">![安裝 Visual Studio Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "安裝 Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="9b42c-548">![Install Visual Studio Express](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image59.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="9b42c-549">*安裝 Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="9b42c-549">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="9b42c-550">閱讀所有產品的授權和詞彙，然後按一下**我接受**才能繼續。</span><span class="sxs-lookup"><span data-stu-id="9b42c-550">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![接受授權條款](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image60.png)

    <span data-ttu-id="9b42c-552">*接受授權條款*</span><span class="sxs-lookup"><span data-stu-id="9b42c-552">*Accepting the license terms*</span></span>
5. <span data-ttu-id="9b42c-553">等待直到完成下載和安裝程序。</span><span class="sxs-lookup"><span data-stu-id="9b42c-553">Wait until the downloading and installation process completes.</span></span>

    ![安裝進度](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image61.png)

    <span data-ttu-id="9b42c-555">*安裝進度*</span><span class="sxs-lookup"><span data-stu-id="9b42c-555">*Installation progress*</span></span>
6. <span data-ttu-id="9b42c-556">當安裝完成時，按一下**完成**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-556">When the installation completes, click **Finish**.</span></span>

    ![安裝已完成](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image62.png)

    <span data-ttu-id="9b42c-558">*安裝已完成*</span><span class="sxs-lookup"><span data-stu-id="9b42c-558">*Installation completed*</span></span>
7. <span data-ttu-id="9b42c-559">按一下**結束**關閉 Web Platform Installer。</span><span class="sxs-lookup"><span data-stu-id="9b42c-559">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="9b42c-560">若要開啟 Visual Studio Express for Web，請移至**啟動**畫面上，並開始書寫&quot; **VS Express**&quot;，然後按一下  **VS Express for Web**並排顯示。</span><span class="sxs-lookup"><span data-stu-id="9b42c-560">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web 方塊](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image63.png)

    <span data-ttu-id="9b42c-562">*VS Express for Web 方塊*</span><span class="sxs-lookup"><span data-stu-id="9b42c-562">*VS Express for Web tile*</span></span>
...
## <a name="appendix-b-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="9b42c-563">附錄 b： 發佈 ASP.NET MVC 4 應用程式使用 Web Deploy</span><span class="sxs-lookup"><span data-stu-id="9b42c-563">Appendix B: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="9b42c-564">此附錄將說明如何從 Windows Azure 管理入口網站建立新的網站和發行您取得依照實驗室中，利用 Web Deploy 發行功能的 Windows Azure 所提供的應用程式。</span><span class="sxs-lookup"><span data-stu-id="9b42c-564">This appendix will show you how to create a new web site from the Windows Azure Management Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Windows Azure.</span></span>

<a id="Ex1Task1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-windows-azure-portal"></a><span data-ttu-id="9b42c-565">工作 1-建立新的網站，從 Windows Azure 入口網站</span><span class="sxs-lookup"><span data-stu-id="9b42c-565">Task 1 - Creating a New Web Site from the Windows Azure Portal</span></span>

1. <span data-ttu-id="9b42c-566">移至[Windows Azure 管理入口網站](https://manage.windowsazure.com/)並使用與您訂用帳戶相關聯的 Microsoft 認證登入。</span><span class="sxs-lookup"><span data-stu-id="9b42c-566">Go to the [Windows Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="9b42c-567">與 Windows Azure 中，您可以免費裝載 10 個 ASP.NET 網站並再擴充隨流量成長。</span><span class="sxs-lookup"><span data-stu-id="9b42c-567">With Windows Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="9b42c-568">您可以註冊[這裡](http://aka.ms/aspnet-hol-azure)。</span><span class="sxs-lookup"><span data-stu-id="9b42c-568">You can sign up [here](http://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="9b42c-569">![登入 Windows Azure 入口網站](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "登入 Windows Azure 入口網站")</span><span class="sxs-lookup"><span data-stu-id="9b42c-569">![Log on to Windows Azure portal](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image64.png "Log on to Windows Azure portal")</span></span>

    <span data-ttu-id="9b42c-570">*登入 Windows Azure 管理入口網站*</span><span class="sxs-lookup"><span data-stu-id="9b42c-570">*Log on to Windows Azure Management Portal*</span></span>
2. <span data-ttu-id="9b42c-571">按一下**新增**命令列上。</span><span class="sxs-lookup"><span data-stu-id="9b42c-571">Click **New** on the command bar.</span></span>

    <span data-ttu-id="9b42c-572">![建立新的網站](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "建立新的網站")</span><span class="sxs-lookup"><span data-stu-id="9b42c-572">![Creating a new Web Site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image65.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="9b42c-573">*建立新的網站*</span><span class="sxs-lookup"><span data-stu-id="9b42c-573">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="9b42c-574">按一下**計算** | **網站**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-574">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="9b42c-575">然後選取**快速建立**選項。</span><span class="sxs-lookup"><span data-stu-id="9b42c-575">Then select **Quick Create** option.</span></span> <span data-ttu-id="9b42c-576">新的網站上提供可用的 URL，然後按一下**建立網站**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-576">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="9b42c-577">Windows Azure 網站是您可以控制和管理在雲端中執行的 web 應用程式的主機。</span><span class="sxs-lookup"><span data-stu-id="9b42c-577">A Windows Azure Web Site is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="9b42c-578">快速建立 選項可讓您部署已完成的 web 應用程式至 Windows Azure 網站從入口網站外部。</span><span class="sxs-lookup"><span data-stu-id="9b42c-578">The Quick Create option allows you to deploy a completed web application to the Windows Azure Web Site from outside the portal.</span></span> <span data-ttu-id="9b42c-579">它不包含設定資料庫的步驟。</span><span class="sxs-lookup"><span data-stu-id="9b42c-579">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="9b42c-580">![建立新的網站使用 快速建立](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "建立新的網站使用 快速建立")</span><span class="sxs-lookup"><span data-stu-id="9b42c-580">![Creating a new Web Site using Quick Create](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image66.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="9b42c-581">*建立新的網站使用 快速建立*</span><span class="sxs-lookup"><span data-stu-id="9b42c-581">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="9b42c-582">等候新**網站**建立。</span><span class="sxs-lookup"><span data-stu-id="9b42c-582">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="9b42c-583">建立網站之後按一下底下的連結**URL**資料行。</span><span class="sxs-lookup"><span data-stu-id="9b42c-583">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="9b42c-584">請檢查新的網站運作。</span><span class="sxs-lookup"><span data-stu-id="9b42c-584">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="9b42c-585">![瀏覽至新的網站](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "瀏覽至新的網站")</span><span class="sxs-lookup"><span data-stu-id="9b42c-585">![Browsing to the new web site](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image67.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="9b42c-586">*瀏覽至新的網站*</span><span class="sxs-lookup"><span data-stu-id="9b42c-586">*Browsing to the new web site*</span></span>

    <span data-ttu-id="9b42c-587">![執行網站](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "執行的網站")</span><span class="sxs-lookup"><span data-stu-id="9b42c-587">![Web site running](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image68.png "Web site running")</span></span>

    <span data-ttu-id="9b42c-588">*執行的網站*</span><span class="sxs-lookup"><span data-stu-id="9b42c-588">*Web site running*</span></span>
6. <span data-ttu-id="9b42c-589">返回入口網站並按一下底下的網站名稱**名稱**資料行會顯示 [管理] 頁面。</span><span class="sxs-lookup"><span data-stu-id="9b42c-589">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="9b42c-590">![開啟網站管理頁面](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "開啟網站管理頁面")</span><span class="sxs-lookup"><span data-stu-id="9b42c-590">![Opening the web site management pages](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image69.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="9b42c-591">*開啟網站管理頁面*</span><span class="sxs-lookup"><span data-stu-id="9b42c-591">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="9b42c-592">在**儀表板**頁面的 **快速概覽**區段中，按一下**下載發行設定檔**連結。</span><span class="sxs-lookup"><span data-stu-id="9b42c-592">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="9b42c-593">*發行設定檔*包含所有 web 應用程式發行至 Windows Azure 網站的每個已啟用的發行方法所需的資訊。</span><span class="sxs-lookup"><span data-stu-id="9b42c-593">The *publish profile* contains all of the information required to publish a web application to a Windows Azure website for each enabled publication method.</span></span> <span data-ttu-id="9b42c-594">發行設定檔包含 Url、 使用者認證和資料庫連接，並對每個端點已啟用的發行集的方法進行驗證所需的字串。</span><span class="sxs-lookup"><span data-stu-id="9b42c-594">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="9b42c-595">**Microsoft WebMatrix 2**， **Microsoft Visual Studio Express for Web**和**Microsoft Visual Studio 2012**支援讀取發行設定檔自動將這些程式的組態web 應用程式發行至 Windows Azure 網站。</span><span class="sxs-lookup"><span data-stu-id="9b42c-595">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Windows Azure websites.</span></span>

    <span data-ttu-id="9b42c-596">![下載網站發行設定檔](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "下載網站發行設定檔")</span><span class="sxs-lookup"><span data-stu-id="9b42c-596">![Downloading the web site publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image70.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="9b42c-597">*下載網站發行設定檔*</span><span class="sxs-lookup"><span data-stu-id="9b42c-597">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="9b42c-598">下載發行設定檔至已知位置。</span><span class="sxs-lookup"><span data-stu-id="9b42c-598">Download the publish profile file to a known location.</span></span> <span data-ttu-id="9b42c-599">進一步在這個練習中，您會看到如何使用這個檔案從 Visual Studio 將 web 應用程式至 Windows Azure 網站發行。</span><span class="sxs-lookup"><span data-stu-id="9b42c-599">Further in this exercise you will see how to use this file to publish a web application to a Windows Azure Web Sites from Visual Studio.</span></span>

    <span data-ttu-id="9b42c-600">![儲存發行設定檔](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "儲存發行設定檔")</span><span class="sxs-lookup"><span data-stu-id="9b42c-600">![Saving the publish profile file](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image71.png "Saving the publish profile")</span></span>

    <span data-ttu-id="9b42c-601">*儲存發行設定檔*</span><span class="sxs-lookup"><span data-stu-id="9b42c-601">*Saving the publish profile file*</span></span>

<a id="Ex1Task2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="9b42c-602">工作 2-設定資料庫伺服器</span><span class="sxs-lookup"><span data-stu-id="9b42c-602">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="9b42c-603">如果您的應用程式會使用 SQL Server 資料庫，您必須建立 SQL Database 伺服器。</span><span class="sxs-lookup"><span data-stu-id="9b42c-603">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="9b42c-604">如果您想要部署簡單的應用程式不會使用 SQL Server，您可能會略過這項工作。</span><span class="sxs-lookup"><span data-stu-id="9b42c-604">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="9b42c-605">您將需要 SQL Database 伺服器來儲存應用程式資料庫。</span><span class="sxs-lookup"><span data-stu-id="9b42c-605">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="9b42c-606">您可以從您的訂用帳戶，在 Windows Azure 管理入口網站中檢視 SQL Database 伺服器**Sql 資料庫** | **伺服器** | **伺服器儀表板**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-606">You can view the SQL Database servers from your subscription in the Windows Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="9b42c-607">如果您沒有建立伺服器，您可以建立一個使用**新增**命令列上的按鈕。</span><span class="sxs-lookup"><span data-stu-id="9b42c-607">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="9b42c-608">請注意**伺服器名稱和 URL、 系統管理員身分登入名稱和密碼**，因為您將在下一個工作中使用它們。</span><span class="sxs-lookup"><span data-stu-id="9b42c-608">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="9b42c-609">並未建立資料庫，因為它會在後續階段中建立。</span><span class="sxs-lookup"><span data-stu-id="9b42c-609">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="9b42c-610">![SQL Database 伺服器儀表板](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "SQL Database 伺服器儀表板")</span><span class="sxs-lookup"><span data-stu-id="9b42c-610">![SQL Database Server Dashboard](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image72.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="9b42c-611">*SQL Database 伺服器儀表板*</span><span class="sxs-lookup"><span data-stu-id="9b42c-611">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="9b42c-612">下一項工作在您將測試資料庫連接，從 Visual Studio，因此您需要在伺服器的清單中包含您的本機 IP 位址**允許的 IP 位址**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-612">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="9b42c-613">若要這樣做，請按一下**設定**，選取 IP 位址從**目前的用戶端 IP 位址**並將它貼上**起始 IP 位址**和**結束 IP 位址**文字方塊。</span><span class="sxs-lookup"><span data-stu-id="9b42c-613">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes.</span></span> <span data-ttu-id="9b42c-614">輸入規則的名稱，然後按一下![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png)  按鈕。</span><span class="sxs-lookup"><span data-stu-id="9b42c-614">Enter a name for the rule and click the ![add-client-ip-address-ok-button](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image73.png) button.</span></span>

    ![加入用戶端 IP 位址](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image74.png)

    <span data-ttu-id="9b42c-616">*加入用戶端 IP 位址*</span><span class="sxs-lookup"><span data-stu-id="9b42c-616">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="9b42c-617">一次**用戶端 IP 位址**新增至允許的 IP 位址清單中，按一下**儲存**來確認變更。</span><span class="sxs-lookup"><span data-stu-id="9b42c-617">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![確認變更](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image75.png)

    <span data-ttu-id="9b42c-619">*確認變更*</span><span class="sxs-lookup"><span data-stu-id="9b42c-619">*Confirm Changes*</span></span>

<a id="Ex1Task3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="9b42c-620">工作 3-發行 ASP.NET MVC 4 應用程式使用 Web Deploy</span><span class="sxs-lookup"><span data-stu-id="9b42c-620">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="9b42c-621">返回至 ASP.NET MVC 4 方案。</span><span class="sxs-lookup"><span data-stu-id="9b42c-621">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="9b42c-622">在**方案總管 中**，以滑鼠右鍵按一下網站專案，然後選取**發行**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-622">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="9b42c-623">![發行應用程式](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "發行應用程式")</span><span class="sxs-lookup"><span data-stu-id="9b42c-623">![Publishing the Application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image76.png "Publishing the Application")</span></span>

    <span data-ttu-id="9b42c-624">*發行網站*</span><span class="sxs-lookup"><span data-stu-id="9b42c-624">*Publishing the web site*</span></span>
2. <span data-ttu-id="9b42c-625">匯入發行設定檔儲存在第一項工作中。</span><span class="sxs-lookup"><span data-stu-id="9b42c-625">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="9b42c-626">![匯入發行設定檔](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "匯入發行設定檔")</span><span class="sxs-lookup"><span data-stu-id="9b42c-626">![Importing the publish profile](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image77.png "Importing the publish profile")</span></span>

    <span data-ttu-id="9b42c-627">*匯入發行設定檔*</span><span class="sxs-lookup"><span data-stu-id="9b42c-627">*Importing publish profile*</span></span>
3. <span data-ttu-id="9b42c-628">按一下**驗證連線**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-628">Click **Validate Connection**.</span></span> <span data-ttu-id="9b42c-629">驗證完成後按一下**下一步**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-629">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="9b42c-630">一旦您看到 [驗證連線] 按鈕旁邊會出現綠色核取記號完成驗證。</span><span class="sxs-lookup"><span data-stu-id="9b42c-630">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="9b42c-631">![驗證連線](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "驗證連線")</span><span class="sxs-lookup"><span data-stu-id="9b42c-631">![Validating connection](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image78.png "Validating connection")</span></span>

    <span data-ttu-id="9b42c-632">*驗證連接*</span><span class="sxs-lookup"><span data-stu-id="9b42c-632">*Validating connection*</span></span>
4. <span data-ttu-id="9b42c-633">在**設定**頁面的 **資料庫**區段中，按一下您的資料庫連接文字方塊旁邊的按鈕 (也就是**DefaultConnection**)。</span><span class="sxs-lookup"><span data-stu-id="9b42c-633">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="9b42c-634">![Web 部署設定](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "Web 部署設定")</span><span class="sxs-lookup"><span data-stu-id="9b42c-634">![Web deploy configuration](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image79.png "Web deploy configuration")</span></span>

    <span data-ttu-id="9b42c-635">*Web 部署設定*</span><span class="sxs-lookup"><span data-stu-id="9b42c-635">*Web deploy configuration*</span></span>
5. <span data-ttu-id="9b42c-636">設定資料庫連接，如下所示：</span><span class="sxs-lookup"><span data-stu-id="9b42c-636">Configure the database connection as follows:</span></span>

    - <span data-ttu-id="9b42c-637">在**伺服器名稱**您 SQL Database 伺服器 URL 使用下列方法類型*tcp:*前置詞。</span><span class="sxs-lookup"><span data-stu-id="9b42c-637">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
    - <span data-ttu-id="9b42c-638">在**使用者名**輸入您的伺服器系統管理員身分登入名稱。</span><span class="sxs-lookup"><span data-stu-id="9b42c-638">In **User name** type your server administrator login name.</span></span>
    - <span data-ttu-id="9b42c-639">在**密碼**輸入伺服器系統管理員身分登入密碼。</span><span class="sxs-lookup"><span data-stu-id="9b42c-639">In **Password** type your server administrator login password.</span></span>
    - <span data-ttu-id="9b42c-640">輸入新的資料庫名稱，例如： *MVC4SampleDB*。</span><span class="sxs-lookup"><span data-stu-id="9b42c-640">Type a new database name, for example: *MVC4SampleDB*.</span></span>

    <span data-ttu-id="9b42c-641">![設定目的地連接字串](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "設定目的地連接字串")</span><span class="sxs-lookup"><span data-stu-id="9b42c-641">![Configuring destination connection string](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image80.png "Configuring destination connection string")</span></span>

    <span data-ttu-id="9b42c-642">*設定目的地連接字串*</span><span class="sxs-lookup"><span data-stu-id="9b42c-642">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="9b42c-643">然後按一下 [確定]。 </span><span class="sxs-lookup"><span data-stu-id="9b42c-643">Then click **OK**.</span></span> <span data-ttu-id="9b42c-644">當系統提示您建立資料庫依序按一下**是**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-644">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="9b42c-645">![建立資料庫](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "建立的資料庫字串")</span><span class="sxs-lookup"><span data-stu-id="9b42c-645">![Creating the database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image81.png "Creating the database string")</span></span>

    <span data-ttu-id="9b42c-646">*建立資料庫*</span><span class="sxs-lookup"><span data-stu-id="9b42c-646">*Creating the database*</span></span>
7. <span data-ttu-id="9b42c-647">您將用來連接到在 Windows Azure SQL Database 的連接字串會顯示在預設連接文字方塊中。</span><span class="sxs-lookup"><span data-stu-id="9b42c-647">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="9b42c-648">然後按 [下一步] 。</span><span class="sxs-lookup"><span data-stu-id="9b42c-648">Then click **Next**.</span></span>

    <span data-ttu-id="9b42c-649">![連接字串指向 SQL Database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "連接字串指向 SQL 資料庫")</span><span class="sxs-lookup"><span data-stu-id="9b42c-649">![Connection string pointing to SQL Database](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image82.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="9b42c-650">*連接字串指向 SQL 資料庫*</span><span class="sxs-lookup"><span data-stu-id="9b42c-650">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="9b42c-651">在**預覽**頁面上，按一下**發行**。</span><span class="sxs-lookup"><span data-stu-id="9b42c-651">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="9b42c-652">![Web 應用程式發行](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "發行 web 應用程式")</span><span class="sxs-lookup"><span data-stu-id="9b42c-652">![Publishing the web application](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image83.png "Publishing the web application")</span></span>

    <span data-ttu-id="9b42c-653">*發行 web 應用程式*</span><span class="sxs-lookup"><span data-stu-id="9b42c-653">*Publishing the web application*</span></span>
9. <span data-ttu-id="9b42c-654">一旦在發佈程序完成時，預設瀏覽器會開啟已發行的網站。</span><span class="sxs-lookup"><span data-stu-id="9b42c-654">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="9b42c-655">![應用程式發行至 Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "應用程式發行至 Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="9b42c-655">![Application published to Windows Azure](whats-new-in-aspnet-and-web-development-in-visual-studio-2012/_static/image84.png "Application published to Windows Azure")</span></span>

    <span data-ttu-id="9b42c-656">*應用程式發行至 Windows Azure*</span><span class="sxs-lookup"><span data-stu-id="9b42c-656">*Application published to Windows Azure*</span></span>
