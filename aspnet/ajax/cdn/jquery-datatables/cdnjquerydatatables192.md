...
---
<a name="jquery-datatables-192"></a><span data-ttu-id="7a0e5-102">jQuery DataTables 1.9.2</span><span class="sxs-lookup"><span data-stu-id="7a0e5-102">jQuery DataTables 1.9.2</span></span>
====================
<span data-ttu-id="7a0e5-103">下列適用於 jQuery DataTables 外掛程式檔案裝載在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="7a0e5-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
