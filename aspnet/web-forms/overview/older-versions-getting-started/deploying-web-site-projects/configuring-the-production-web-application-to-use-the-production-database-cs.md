...
**圖 3**: The Data-Driven 應用程式是現在可在生產環境 ！ ([按一下以檢視完整大小的影像](configuring-the-production-web-application-to-use-the-production-database-cs/_static/image9.jpg))
