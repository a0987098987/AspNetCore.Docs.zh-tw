...
---
<a name="jquery-datatables-1104"></a><span data-ttu-id="99cfe-102">jQuery DataTables 1.10.4</span><span class="sxs-lookup"><span data-stu-id="99cfe-102">jQuery DataTables 1.10.4</span></span>
====================
<span data-ttu-id="99cfe-103">下列適用於 jQuery DataTables 外掛程式檔案裝載在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="99cfe-103">The following files for the jQuery DataTables plugins are hosted on the CDN:</span></span>
