...
---
# <a name="author-tag-helpers-in-aspnet-core-a-walkthrough-with-samples"></a>在 ASP.NET Core 中編寫標籤協助程式，一個包含範例的逐步解說
...
2.  若要讓 `EmailTagHelper` 類別可供所有 Razor 檢視使用，請將 `addTagHelper` 指示詞新增至 *Views/_ViewImports.cshtml* 檔案：[!code-html[Main](../../../mvc/views/tag-helpers/authoring/sample/AuthoringTagHelpers/src/AuthoringTagHelpers/Views/_ViewImportsCopyEmail.cshtml?highlight=2,3)]
...
注意：與 Razor 和 C# 中的 HTML 標籤和屬性、標籤、類別名稱和屬性類似，不區分大小寫。
...
1.  使用下列變更來更新 *Views/Home/Contact.cshtml* 檔案中的標記：[!code-html[Main](../../../mvc/views/tag-helpers/authoring/sample/AuthoringTagHelpers/src/AuthoringTagHelpers/Views/Home/ContactCopy.cshtml?highlight=15,16)]
