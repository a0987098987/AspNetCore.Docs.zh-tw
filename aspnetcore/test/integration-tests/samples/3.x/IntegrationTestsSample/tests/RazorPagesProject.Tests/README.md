# <a name="aspnet-core-integration-testing-sample"></a><span data-ttu-id="55b10-101">ASP.NET核心整合測試範例</span><span class="sxs-lookup"><span data-stu-id="55b10-101">ASP.NET Core Integration Testing Sample</span></span>
