...
<span data-ttu-id="2b9a1-247">在本教學課程中，我們可以使用 Microsoft Entity Framework 從資料庫中自動產生的模型類別。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-247">In this tutorial, we use the Microsoft Entity Framework to generate a model class from the database automatically.</span></span>
...
<span data-ttu-id="2b9a1-279">**圖 10**: 連絡人類別 ([按一下以檢視完整大小的影像](iteration-1-create-the-application-vb/_static/image20.png))</span><span class="sxs-lookup"><span data-stu-id="2b9a1-279">**Figure 10**: The Contact class ([Click to view full-size image](iteration-1-create-the-application-vb/_static/image20.png))</span></span>
...
<span data-ttu-id="2b9a1-293">若要顯示在 [連絡人] 資料庫資料表中的記錄，我們要建立 index 動作和索引檢視。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-293">In order to display the records in the Contacts database table, we need to create an Index() action and an Index view.</span></span>
...
<span data-ttu-id="2b9a1-330">**圖 14**： 啟用偵錯 ([按一下以檢視完整大小的影像](iteration-1-create-the-application-vb/_static/image28.png))</span><span class="sxs-lookup"><span data-stu-id="2b9a1-330">**Figure 14**: Enabling debugging ([Click to view full-size image](iteration-1-create-the-application-vb/_static/image28.png))</span></span>
...
<span data-ttu-id="2b9a1-413">與不同的是如果清單中，建立、 和編輯檢視中，加入檢視 對話方塊不會包含建立刪除檢視的選項。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-413">Unlike in the case of the List, Create, and Edit views, the Add View dialog does not contain an option to create a Delete view.</span></span> <span data-ttu-id="2b9a1-414">相反地，選取**ContactManager.Models.Contact**資料類別和**空**檢視內容。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-414">Instead, select the **ContactManager.Models.Contact** data class and the **Empty** view content.</span></span> <span data-ttu-id="2b9a1-415">選取空的檢視內容 選項將要求我們建立自己的檢視。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-415">Selecting the Empty view content option will require us to create the view ourselves.</span></span>


<span data-ttu-id="2b9a1-416">[![新增專案 對話方塊](iteration-1-create-the-application-vb/_static/image22.jpg)](iteration-1-create-the-application-vb/_static/image43.png)</span><span class="sxs-lookup"><span data-stu-id="2b9a1-416">[![The New Project dialog box](iteration-1-create-the-application-vb/_static/image22.jpg)](iteration-1-create-the-application-vb/_static/image43.png)</span></span>

<span data-ttu-id="2b9a1-417">**圖 22**： 加入刪除確認檢視 ([按一下以檢視完整大小的影像](iteration-1-create-the-application-vb/_static/image44.png))</span><span class="sxs-lookup"><span data-stu-id="2b9a1-417">**Figure 22**: Adding the delete confirmation view ([Click to view full-size image](iteration-1-create-the-application-vb/_static/image44.png))</span></span>


<span data-ttu-id="2b9a1-418">刪除檢視的內容會包含在列出 9。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-418">The content of the Delete view is contained in Listing 9.</span></span> <span data-ttu-id="2b9a1-419">這個檢視包含表單，以確認是否應為特定連絡人刪除 （請參閱圖 21）。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-419">This view contains a form that confirms whether or not a particular contact should be deleted (see Figure 21).</span></span>

<span data-ttu-id="2b9a1-420">**列出 9-Views\Home\Delete.aspx**</span><span class="sxs-lookup"><span data-stu-id="2b9a1-420">**Listing 9 - Views\Home\Delete.aspx**</span></span>

[!code-aspx[Main](iteration-1-create-the-application-vb/samples/sample9.aspx)]

## <a name="changing-the-name-of-the-default-controller"></a><span data-ttu-id="2b9a1-421">變更預設的控制站的名稱</span><span class="sxs-lookup"><span data-stu-id="2b9a1-421">Changing the Name of the Default Controller</span></span>

<span data-ttu-id="2b9a1-422">它可能會對您造成困擾的控制器類別的名稱使用連絡人的名稱是 HomeController 類別。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-422">It might bother you that the name of our controller class for working with contacts is named the HomeController class.</span></span> <span data-ttu-id="2b9a1-423">應該不 t 控制器命名為 ContactController 嗎？</span><span class="sxs-lookup"><span data-stu-id="2b9a1-423">Shouldn t the controller be named ContactController?</span></span>

<span data-ttu-id="2b9a1-424">此問題很容易修正。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-424">This issue is easy enough to fix.</span></span> <span data-ttu-id="2b9a1-425">首先，我們需要重構主控制器的名稱。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-425">First, we need to refactor the name of the Home controller.</span></span> <span data-ttu-id="2b9a1-426">在 Visual Studio 程式碼編輯器中開啟 HomeController 類別，以滑鼠右鍵按一下類別的名稱並選取功能表選項**重新命名**。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-426">Open the HomeController class in the Visual Studio Code Editor, right click the name of the class and select the menu option **Rename**.</span></span> <span data-ttu-id="2b9a1-427">選取此功能表選項會開啟 [重新命名] 對話方塊。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-427">Selecting this menu option opens the Rename dialog.</span></span>


<span data-ttu-id="2b9a1-428">[![新增專案 對話方塊](iteration-1-create-the-application-vb/_static/image23.jpg)](iteration-1-create-the-application-vb/_static/image45.png)</span><span class="sxs-lookup"><span data-stu-id="2b9a1-428">[![The New Project dialog box](iteration-1-create-the-application-vb/_static/image23.jpg)](iteration-1-create-the-application-vb/_static/image45.png)</span></span>

<span data-ttu-id="2b9a1-429">**圖 23**： 重構的控制器名稱 ([按一下以檢視完整大小的影像](iteration-1-create-the-application-vb/_static/image46.png))</span><span class="sxs-lookup"><span data-stu-id="2b9a1-429">**Figure 23**: Refactoring a controller name ([Click to view full-size image](iteration-1-create-the-application-vb/_static/image46.png))</span></span>


<span data-ttu-id="2b9a1-430">[![新增專案 對話方塊](iteration-1-create-the-application-vb/_static/image24.jpg)](iteration-1-create-the-application-vb/_static/image47.png)</span><span class="sxs-lookup"><span data-stu-id="2b9a1-430">[![The New Project dialog box](iteration-1-create-the-application-vb/_static/image24.jpg)](iteration-1-create-the-application-vb/_static/image47.png)</span></span>

<span data-ttu-id="2b9a1-431">**圖 24**： 使用重新命名對話方塊 ([按一下以檢視完整大小的影像](iteration-1-create-the-application-vb/_static/image48.png))</span><span class="sxs-lookup"><span data-stu-id="2b9a1-431">**Figure 24**: Using the Rename dialog ([Click to view full-size image](iteration-1-create-the-application-vb/_static/image48.png))</span></span>


<span data-ttu-id="2b9a1-432">如果您重新命名控制器類別時，Visual Studio 會更新檢視 資料夾中資料夾的名稱。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-432">If you rename your controller class, Visual Studio will update the name of the folder in the Views folder as well.</span></span> <span data-ttu-id="2b9a1-433">Visual Studio 會將 \Views\Home 資料夾重新命名 \Views\Contact 資料夾。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-433">Visual Studio will rename the \Views\Home folder to the \Views\Contact folder.</span></span>

<span data-ttu-id="2b9a1-434">進行這項變更之後，您的應用程式將不再有主控制器。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-434">After you make this change, your application will no longer have a Home controller.</span></span> <span data-ttu-id="2b9a1-435">當您執行您的應用程式時，您會取得在圖 25 的錯誤頁面。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-435">When you run your application, you'll get the error page in Figure 25.</span></span>


<span data-ttu-id="2b9a1-436">[![新增專案 對話方塊](iteration-1-create-the-application-vb/_static/image25.jpg)](iteration-1-create-the-application-vb/_static/image49.png)</span><span class="sxs-lookup"><span data-stu-id="2b9a1-436">[![The New Project dialog box](iteration-1-create-the-application-vb/_static/image25.jpg)](iteration-1-create-the-application-vb/_static/image49.png)</span></span>

<span data-ttu-id="2b9a1-437">**圖 25**： 預設的控制站 ([按一下以檢視完整大小的影像](iteration-1-create-the-application-vb/_static/image50.png))</span><span class="sxs-lookup"><span data-stu-id="2b9a1-437">**Figure 25**: No default controller ([Click to view full-size image](iteration-1-create-the-application-vb/_static/image50.png))</span></span>


<span data-ttu-id="2b9a1-438">我們需要更新使用連絡控制器，而不是主控制器的 Global.asax 檔中的預設路由。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-438">We need to update the default route in the Global.asax file to use the Contact controller instead of the Home controller.</span></span> <span data-ttu-id="2b9a1-439">開啟 Global.asax 檔案並修改預設路由 （請參閱列出 10） 所使用的預設控制站。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-439">Open the Global.asax file and modify the default controller used by the default route (see Listing 10).</span></span>

<span data-ttu-id="2b9a1-440">**列出 10-Global.asax.vb**</span><span class="sxs-lookup"><span data-stu-id="2b9a1-440">**Listing 10 - Global.asax.vb**</span></span>

[!code-vb[Main](iteration-1-create-the-application-vb/samples/sample10.vb)]

<span data-ttu-id="2b9a1-441">進行這些變更之後，請連絡管理員將會正確執行。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-441">After you make these changes, the Contact Manager will run correctly.</span></span> <span data-ttu-id="2b9a1-442">現在，它會使用連絡人控制器類別做為預設的控制站。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-442">Now, it will use the Contact controller class as the default controller.</span></span>

## <a name="summary"></a><span data-ttu-id="2b9a1-443">總結</span><span class="sxs-lookup"><span data-stu-id="2b9a1-443">Summary</span></span>

<span data-ttu-id="2b9a1-444">此第一個反覆項目中基本的連絡人管理員應用程式中建立最快速的方式可能。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-444">In this first iteration, we created a basic Contact Manager application in the fastest way possible.</span></span> <span data-ttu-id="2b9a1-445">我們已利用 Visual Studio 自動產生我們控制器和檢視表之初始程式碼。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-445">We took advantage of Visual Studio to generate the initial code for our controllers and views automatically.</span></span> <span data-ttu-id="2b9a1-446">我們也已利用 Entity Framework 自動產生資料庫模型類別。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-446">We also took advantage of the Entity Framework to generate our database model classes automatically.</span></span>

<span data-ttu-id="2b9a1-447">目前，我們可以清單、 建立、 編輯和刪除連絡人記錄，請連絡系統管理員應用程式使用。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-447">Currently, we can list, create, edit, and delete contact records with the Contact Manager application.</span></span> <span data-ttu-id="2b9a1-448">換句話說，我們可以執行所有資料庫驅動的 web 應用程式所需的基本資料庫作業。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-448">In other words, we can perform all of the basic database operations required by a database-driven web application.</span></span>

<span data-ttu-id="2b9a1-449">不幸的是，我們的應用程式有一些問題。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-449">Unfortunately, our application has some problems.</span></span> <span data-ttu-id="2b9a1-450">第一個與我遲疑著要不要承認，不過，請連絡系統管理員應用程式不是最具吸引力的應用程式。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-450">First and I hesitate to admit this, the Contact Manager application is not the most attractive application.</span></span> <span data-ttu-id="2b9a1-451">它需要一些設計工作。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-451">It needs some design work.</span></span> <span data-ttu-id="2b9a1-452">中的下一個反覆項目中，我們將探討如何變更預設檢視主版頁面和階層式樣式表可以改善應用程式的外觀。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-452">In the next iteration, we'll look at how we can change the default view master page and cascading style sheet to improve the appearance of the application.</span></span>

<span data-ttu-id="2b9a1-453">其次，我們未實作的任何表單驗證。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-453">Second, we have not implemented any form validation.</span></span> <span data-ttu-id="2b9a1-454">例如，沒有任何可防止您在建立連絡人表單提交不需要輸入任何為表單欄位值。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-454">For example, there is nothing to prevent you from submitting the Create contact form without entering values for any of the form fields.</span></span> <span data-ttu-id="2b9a1-455">此外，您可以輸入不正確的電話號碼和電子郵件地址。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-455">Furthermore, you can enter invalid phone numbers and email addresses.</span></span> <span data-ttu-id="2b9a1-456">我們一開始解決問題的反覆項目 #3 中的表單驗證。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-456">We start to tackle the problem of form validation in iteration #3.</span></span>

<span data-ttu-id="2b9a1-457">最後，並最重要的是，請連絡系統管理員應用程式的目前反覆項目無法輕鬆地修改或維護。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-457">Finally, and most importantly, the current iteration of the Contact Manager application cannot be easily modified or maintained.</span></span> <span data-ttu-id="2b9a1-458">例如，將資料庫存取邏輯被本意右邊控制器動作。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-458">For example, the database access logic is baked right into the controller actions.</span></span> <span data-ttu-id="2b9a1-459">這表示，我們無法修改資料存取程式碼，而不需修改我們控制站。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-459">This means that we cannot modify our data access code without modifying our controllers.</span></span> <span data-ttu-id="2b9a1-460">在稍後的反覆項目，我們會探討軟體設計樣式是我們可以實作以進行更有彈性，若要變更連絡管理員。</span><span class="sxs-lookup"><span data-stu-id="2b9a1-460">In later iterations, we explore software design patterns that we can implement to make the Contact Manager more resilient to change.</span></span>

> [!div class="step-by-step"]
> <span data-ttu-id="2b9a1-461">[上一頁](iteration-7-add-ajax-functionality-cs.md)
> [下一頁](iteration-2-make-the-application-look-nice-vb.md)</span><span class="sxs-lookup"><span data-stu-id="2b9a1-461">[Previous](iteration-7-add-ajax-functionality-cs.md)
