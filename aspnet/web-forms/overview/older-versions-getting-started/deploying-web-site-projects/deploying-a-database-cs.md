...
**圖 1**: 的書籍評論 Web 應用程式資料庫是包含的四個資料表 ([按一下以檢視完整大小的影像](deploying-a-database-cs/_static/image3.jpg))
...
**[圖 4**： 在資料庫總管] 或 [伺服器總管] 找出資料庫 ([按一下以檢視完整大小的影像](deploying-a-database-cs/_static/image12.jpg))
...
**圖 8**： 指定發佈選項 ([按一下以檢視完整大小的影像](deploying-a-database-cs/_static/image24.jpg))
