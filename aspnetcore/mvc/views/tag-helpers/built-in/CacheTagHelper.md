...
決定是否要快取內容快取標記協助程式 」 所括住。 預設為 `true`。  如果設定為`false`此快取標記協助程式不會影響快取上轉譯的輸出。
...
### <a name="vary-by-cookie"></a>改變-由-cookie

| 屬性類型    | 範例值                |
|----------------   |----------------               |
| 字串            | ".AspNetCore.Identity.Application"                |
