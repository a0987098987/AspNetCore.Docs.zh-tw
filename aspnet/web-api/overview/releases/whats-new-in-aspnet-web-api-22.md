...
<span data-ttu-id="4e4b6-129">以下是一些主要功能與 OData v4 的變更：</span><span class="sxs-lookup"><span data-stu-id="4e4b6-129">Here are some of the key features and changes for OData v4:</span></span>
