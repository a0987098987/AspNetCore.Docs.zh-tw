...
如果您的解決方案依賴[global json](/dotnet/core/tools/global-json)檔案以特定 .NET Core SDK 版本為目標，請將其 @no__t 1 屬性更新為安裝在您電腦上的3.0 版本：
...
如需詳細資訊，請參閱[此 GitHub 問題](https://github.com/aspnet/EntityFrameworkCore/issues/17788)。
