...
ms.locfileid: "36960628"
---
[!INCLUDE [SQLlite](../../includes/RP/sql.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="9c1e8-103">[上一步：新增模型](xref:tutorials/razor-pages-vsc/model)
> [下一步：更新頁面](xref:tutorials/razor-pages-vsc/da1)</span><span class="sxs-lookup"><span data-stu-id="9c1e8-103">[Previous: Adding a model](xref:tutorials/razor-pages-vsc/model)
