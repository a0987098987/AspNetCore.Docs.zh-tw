...
---
<a name="multiple-contentplaceholders-and-default-content-vb"></a>多個 ContentPlaceHolders 和預設內容 (VB)
====================
...
**圖 04**： 針對 [設計] 檢視`About.aspx`示範`LeftColumnContent`ContentPlaceHolder ([按一下以檢視完整大小的影像](multiple-contentplaceholders-and-default-content-vb/_static/image12.png))
