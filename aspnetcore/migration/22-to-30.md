...
* `IHostingEnvironment` `IWebHostEnvironment`，請參閱[此 GitHub 公告](https://github.com/aspnet/AspNetCore/issues/7749)。
...
* 如果應用程式會執行 `IRouter` 或繼承自 `Route`，請使用[DynamicRouteValuesTransformer](https://github.com/aspnet/AspNetCore.Docs/issues/12997)做為取代。
