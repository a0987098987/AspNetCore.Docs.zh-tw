...
- [Visual Studio 和 ASP.NET 的 web 部署概觀](https://msdn.microsoft.com/en-us/library/dd394698.aspx)(MSDN)。
...
- [如何： 部署 Web 專案使用單鍵發行 Visual Studio 中](https://msdn.microsoft.com/en-us/library/dd465337.aspx)（參考 Visual Studio Web Publish 精靈的資訊）。
...
- [如何： 在 Visual Studio 中建立 Web 部署套件](https://msdn.microsoft.com/en-us/library/dd465323.aspx)(MSDN)。
- [如何： 建立使用 deploy.cmd 檔的部署套件的 Visual studio 的安裝](https://msdn.microsoft.com/en-us/library/ff356104.aspx)(MSDN)。
...
- [使用 Visual Studio Web 專案部署的 Web.config 轉換語法](https://msdn.microsoft.com/en-us/library/dd465326.aspx)(MSDN)。
- [Web 工具 2012.2-web.config 轉換](https://www.youtube.com/watch?v=HdPK8mxpKEI)（YouTube 影片所 Sayed Hashimi）。 示範如何設定並預覽 Web.config 轉換。
- [如何停用 Web.config 轉換？](https://msdn.microsoft.com/en-us/library/ee942158.aspx#disable_web_config_transformation) (MSDN)。
- [何時應該使用 Web Deploy 參數而不是 Web.config 轉換？](https://msdn.microsoft.com/en-us/library/ee942158.aspx#web_deploy_parameters) (MSDN)。
...
- [如何： 使用 Web Deploy Web 部署套件中的參數](https://msdn.microsoft.com/en-us/library/ff398068.aspx)(MSDN)。
...
- [Visual Studio 中設定資料庫部署](https://msdn.microsoft.com/en-us/library/dd394698.aspx#dbdeployment)(MSDN)。 部署 web 專案的資料庫選項的概觀。
...
- [如何： 部署 Web 專案中使用單鍵發行 Visual Studio 中](https://msdn.microsoft.com/en-us/library/dd465337.aspx)(MSDN)。
...
- [將資料庫移轉至 Windows Azure SQL Database (先前稱為 SQL Azure)](https://msdn.microsoft.com/en-us/library/windowsazure/ee730904.aspx) (MSDN)。
...
- [將資料中心的應用程式移轉至 Windows Azure](https://msdn.microsoft.com/en-us/library/jj156154.aspx) (MSDN)。
...
- [ASP.NET Web 應用程式專案先行編譯概觀](https://msdn.microsoft.com/en-us/library/aa983464.aspx)(MSDN)。
- [封裝/發行 Web 索引標籤中，專案屬性](https://msdn.microsoft.com/en-us/library/dd410108.aspx)(MSDN)。
- [進階設定 對話方塊的先行編譯](https://msdn.microsoft.com/en-us/library/hh475319.aspx)(MSDN)。
...
- [如何建立使用 ASP.NET MVC 內部網路網站](https://msdn.microsoft.com/en-us/library/gg703322(VS.98).aspx)(MSDN)。 較舊的逐步解說寫入 for Visual Studio 2010，並不會反映在內部網路專案範本在 Visual Studio 2013 中導入重大變更。
...
- [Web 部署常見問題集適用於 Visual Studio 和 ASP.NET](https://msdn.microsoft.com/en-us/library/ee942158.aspx) (MSDN)。
