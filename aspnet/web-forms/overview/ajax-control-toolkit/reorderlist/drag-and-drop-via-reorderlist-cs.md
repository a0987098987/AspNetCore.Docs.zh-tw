...
---
<a name="drag-and-drop-via-reorderlist-c"></a>將拖放透過 reorderlist 的回傳 (C#)
====================
...
資料庫變更，根據新的清單中的資料，項目順序 ([按一下以檢視完整大小的影像](drag-and-drop-via-reorderlist-cs/_static/image9.png))
