...
---
<a name="jqueryvalidate-version-19"></a><span data-ttu-id="6d872-102">jquery.validate 1.9 版</span><span class="sxs-lookup"><span data-stu-id="6d872-102">jquery.validate version 1.9</span></span>
====================
<span data-ttu-id="6d872-103">下列檔案裝載在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="6d872-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="6d872-104">在檔案的當地語系化https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js其中 # # 是當地語系化程式碼。</span><span class="sxs-lookup"><span data-stu-id="6d872-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages\_##.js where ## is the loc code.</span></span>
