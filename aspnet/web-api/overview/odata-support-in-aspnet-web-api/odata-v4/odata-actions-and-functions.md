...
<span data-ttu-id="3d78a-133">在 WebApiConfig.cs 中，新增下列程式碼：</span><span class="sxs-lookup"><span data-stu-id="3d78a-133">In WebApiConfig.cs, add the following code:</span></span>
