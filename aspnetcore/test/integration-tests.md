...
* 有的套件參考[Microsoft.AspNetCore.App](https://www.nuget.org/packages/Microsoft.AspNetCore.App/)。
* 專案檔中使用 Web SDK (`<Project Sdk="Microsoft.NET.Sdk.Web">`)。
