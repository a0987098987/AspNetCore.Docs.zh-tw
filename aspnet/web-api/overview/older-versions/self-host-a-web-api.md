...
若要檢查是否已安裝 NuGet 套件管理員，請按一下**工具**Visual Studio 中的功能表。 如果您看到的功能表項目呼叫**程式庫套件管理員**，則您可以 NuGet 套件管理員。
...
1. 從**工具**功能表上，選取**程式庫套件管理員**。 *請注意*： 如果您不會看到此功能表項目，請確定已正確安裝該 NuGet 套件管理員。
2. 選取**管理方案的 NuGet 套件...**
