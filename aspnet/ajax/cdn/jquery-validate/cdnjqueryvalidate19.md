...
ms.locfileid: "30070871"
---
<a name="jqueryvalidate-version-19"></a>1.9 版 jquery.validate 版本
====================
在 CDN 上裝載下列檔案：
...
- 使用位於檔案當地語系化https://ajax.aspnetcdn.com/ajax/jquery.validate/1.9/localization/messages \_# #.js 其中 # # 是當地語系化程式碼。
