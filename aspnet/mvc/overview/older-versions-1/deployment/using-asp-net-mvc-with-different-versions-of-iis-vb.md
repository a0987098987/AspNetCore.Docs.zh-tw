...
重要事項： 請記得變更 Global.asax 檔案後，再建置您的 ASP.NET MVC 應用程式。
...
**圖 3**： 萬用字元指令碼對應建立搭配 IIS 7.0 ([按一下以檢視完整大小的影像](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image6.png))
...
**圖 4**: IIS 6.0 建立萬用字元指令碼對應 ([按一下以檢視完整大小的影像](using-asp-net-mvc-with-different-versions-of-iis-vb/_static/image8.png))
