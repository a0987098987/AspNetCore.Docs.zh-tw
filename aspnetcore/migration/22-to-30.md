...
* 如果您的應用程式使用[API 分析器](xref:web-api/advanced/analyzers)， `<PackageReference>`請移除[AspNetCore](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.Api.Analyzers/)套件的任何元素。 編輯您的專案檔，以使用隨附于 .NET Core SDK 中的分析器：
