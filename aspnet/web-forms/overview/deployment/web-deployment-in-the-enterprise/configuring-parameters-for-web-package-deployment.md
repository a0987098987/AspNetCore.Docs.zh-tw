...
- <span data-ttu-id="f53af-147">服務端點中的*web.config*檔案。</span><span class="sxs-lookup"><span data-stu-id="f53af-147">Service endpoints in the *web.config* file.</span></span>
