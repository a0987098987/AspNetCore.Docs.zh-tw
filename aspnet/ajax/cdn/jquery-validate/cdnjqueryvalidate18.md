...
---
<a name="jqueryvalidate-version-18"></a><span data-ttu-id="541a7-102">jquery.validate 1.8 版</span><span class="sxs-lookup"><span data-stu-id="541a7-102">jquery.validate version 1.8</span></span>
====================
<span data-ttu-id="541a7-103">下列檔案裝載在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="541a7-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="541a7-104">在檔案的當地語系化 https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js其中 # # 是當地語系化程式碼。</span><span class="sxs-lookup"><span data-stu-id="541a7-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8/localization/messages\_##.js where ## is the loc code.</span></span>
