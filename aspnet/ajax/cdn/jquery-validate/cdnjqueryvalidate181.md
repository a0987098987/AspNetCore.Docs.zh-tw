...
---
<a name="jqueryvalidate-version-181"></a><span data-ttu-id="c8dd6-102">jquery.validate 1.8.1 版</span><span class="sxs-lookup"><span data-stu-id="c8dd6-102">jquery.validate version 1.8.1</span></span>
====================
<span data-ttu-id="c8dd6-103">下列檔案裝載在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="c8dd6-103">The following files are hosted on the CDN:</span></span>
...
- <span data-ttu-id="c8dd6-104">在檔案的當地語系化 https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js其中 # # 是當地語系化程式碼。</span><span class="sxs-lookup"><span data-stu-id="c8dd6-104">Localization Files at https://ajax.aspnetcdn.com/ajax/jquery.validate/1.8.1/localization/messages\_##.js where ## is the loc code.</span></span>
