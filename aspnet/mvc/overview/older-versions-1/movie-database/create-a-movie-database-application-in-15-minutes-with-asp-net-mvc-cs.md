...
讓我們開始在 Visual Studio 2008 中建立新的 ASP.NET MVC Web 應用程式專案。 選取功能表選項**檔案、 新的專案**，您會看到在圖 1 中新增專案 對話方塊。 選取 C# 當做程式語言，然後選取 ASP.NET MVC Web 應用程式專案範本。 為您的專案名稱 MovieApp，然後按一下 [確定] 按鈕。
...
**圖 01**: 新的專案 對話方塊 ([按一下以檢視完整大小的影像](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image2.png))
...
**圖 05**： 輸入電影的記錄 ([按一下以檢視完整大小的影像](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image10.png))
...
**圖 06**： 產生的資料庫模型，使用實體資料模型精靈 ([按一下以檢視完整大小的影像](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image12.png))
...
**圖 07**: Entity Data Model Designer ([按一下以檢視完整大小的影像](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image14.png))
...
**圖 08**： 加入新的 ASP.NET MVC 控制器 ([按一下以檢視完整大小的影像](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image16.png))
...
**列出 2 – Controllers/HomeController.cs （修改索引的方法）**
...
索引檢視會顯示所有電影記錄的 HTML 資料表中的電影資料庫資料表。 此檢視包含 「 foreach 迴圈 」 可逐一查看每個影片 ViewData.Model 屬性所代表。 如果您按下 F5 鍵執行應用程式，您會看到圖 11 網頁。
...
**圖 11**: 索引檢視 ([按一下以檢視完整大小的影像](create-a-movie-database-application-in-15-minutes-with-asp-net-mvc-cs/_static/image22.png))
...
**列出 4 – Controllers\HomeController.cs （已修改的建立方式）**
...
首先，我們需要產生的編輯表單。 這個步驟很簡單，因為 Visual Studio 會產生的編輯表單為我們自動。 在 Visual Studio 程式碼編輯器中開啟 HomeController.cs 類別，並遵循下列步驟：
...
**列出 6 – Controllers\HomeController.cs （編輯方法）**
