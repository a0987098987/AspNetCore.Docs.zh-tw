...
6. <span data-ttu-id="23d5a-166">以下列內容取代現有的內容：</span><span class="sxs-lookup"><span data-stu-id="23d5a-166">Replace the existing content with the following:</span></span> 
