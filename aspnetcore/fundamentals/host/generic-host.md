...
* 接聽 Ctrl + C/SIGINT 或 SIGTERM，並呼叫 <xref:Microsoft.Extensions.Hosting.IHostApplicationLifetime.StopApplication*> 以開始關機程式。
...
**類型**：*int*  
**預設值**：5秒的**環境變數**： `<PREFIX_>SHUTDOWNTIMEOUTSECONDS`
