...
* [使用 AAD 託管](xref:security/blazor/webassembly/hosted-with-azure-active-directory)
...
[AuthorizeView 元件](xref:security/blazor/index#authorizeview-component)適用于下列原則：
...
原則檢查也可以在程式[代碼中以程式邏輯執行](xref:security/blazor/index#procedural-logic)：
