...
---
# <a name="secure-an-aspnet-core-opno-locblazor-webassembly-standalone-app-with-azure-active-directory"></a>使用 AzureBlazor活動目錄保護ASP.NET核心 Web 大會獨立應用
...
要建立Blazor[Azure 活動目錄 (AAD)](https://azure.microsoft.com/services/active-directory/)進行身份驗證的 Web 組裝獨立應用,請執行:

[建立 AAD 租戶與 Web 應用程式](/azure/active-directory/develop/v2-overview):

在 Azure 門戶的**Azure 活動目錄** > **應用註冊區域註冊**AAD 應用:

1. 為應用提供**名稱**(例如,**Blazor用戶端 AAD**)。
1. 選擇**支援的帳號型態 。** 您只能選擇**這個組織目錄中的帳號**。
...
* 應用程式代碼(用戶端代碼)(例如`11111111-1111-1111-1111-111111111111`)
* 目錄 ID(租戶代碼)(`22222222-2222-2222-2222-222222222222`例如 )
