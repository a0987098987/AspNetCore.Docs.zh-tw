...
* [Visual Studio 2017 版本 15.9 以後](https://www.visualstudio.com/downloads/)具有**ASP.NET 和 web 開發**工作負載
...
* [.NET core SDK 2.2 或更新版本](https://www.microsoft.com/net/download/all)（隨附於 Visual Studio 安裝）
