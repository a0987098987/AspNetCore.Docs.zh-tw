...
### [處理並行存取衝突](data/ef-mvc/concurrency.md)
...
## [使用啟動程序建置美觀的回應式網站](xref:client-side/bootstrap)
...
### [Visual Studio for ASP.NET Core 中的開發階段 IIS 支援](xref:publishing/development-time-iis-support)
...
### [在 ASP.NET 身分識別中啟用 QR 代碼產生](xref:security/authentication/identity-enable-qrcodes)
