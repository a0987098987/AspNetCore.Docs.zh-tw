...
如需詳細資訊，請參閱[ContentRootPath](/aspnet/core/fundamentals/host/generic-host?view=aspnetcore-3.0#contentrootpath)

::: moniker-end

::: moniker range="< aspnetcore-3.0"

如需詳細資訊，請參閱 [Web 根目錄](/aspnet/core/fundamentals/host/web-host#webroot)。
