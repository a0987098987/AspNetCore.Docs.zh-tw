...
本系列會說明使用 Visual Studio 的 ASP.NET Core 來建置 Razor Pages Web 應用程式的基本概念。 此系列的其他版本包括 [Mac 版本](xref:tutorials/razor-pages-mac/index)與 [Visual Studio Code 版本](xref:tutorials/razor-pages-vsc/index)。

1. [開始使用 Razor Pages](xref:tutorials/razor-pages/razor-pages-start)
1. [將模型新增至 Razor Pages 應用程式](xref:tutorials/razor-pages/model)
...
1. [上傳檔案](xref:tutorials/razor-pages/uploading-files)
