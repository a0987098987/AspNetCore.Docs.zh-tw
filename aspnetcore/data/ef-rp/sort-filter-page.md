...
如果您遇到無法解決的問題，請下載[已完成的應用程式](https://github.com/aspnet/Docs/tree/master/aspnetcore/data/ef-rp/intro/samples/StageSnapShots/cu-part3-sorting)。
...
* 為 **About** 頁面所使用的資料，建立檢視模型類別。
* 修改 About Razor 頁面和頁面模型。
