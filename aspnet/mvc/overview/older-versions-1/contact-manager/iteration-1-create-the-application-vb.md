...
在**加入檢視** 對話方塊中，選取核取方塊標示為**建立強型別檢視**。 選取檢視資料類別 ContactManager.Contact 和檢視的內容清單。 選取這些選項會產生一個檢視，顯示一份連絡人記錄。
...
**圖 15**: 索引檢視 ([按一下以檢視完整大小的影像](iteration-1-create-the-application-vb/_static/image30.png))
...
**列出 4-Controllers\HomeController.vb （與建立方法）**
...
在**加入檢視**對話方塊中，選取**ContactManager.Contact**類別和**建立**檢視內容的選項 （請參閱圖 17）。 當您按一下**新增**按鈕，建立檢視時自動產生。
...
**圖 17**： 看到分裂頁面 ([按一下以檢視完整大小的影像](iteration-1-create-the-application-vb/_static/image34.png))
...
**列出 6-Controllers\HomeController.vb （與編輯方法）**
...
**列出 8-Controllers\HomeController.vb （Delete 方法）**
...
此問題很容易修正。 首先，我們需要重構主控制器的名稱。 在 Visual Studio 程式碼編輯器中開啟 HomeController 類別，以滑鼠右鍵按一下類別的名稱並選取功能表選項**重新命名**。 選取此功能表選項會開啟 [重新命名] 對話方塊。
...
**圖 24**： 使用重新命名對話方塊 ([按一下以檢視完整大小的影像](iteration-1-create-the-application-vb/_static/image48.png))
