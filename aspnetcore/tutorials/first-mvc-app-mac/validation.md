...
ms.locfileid: "30895309"
---
[!INCLUDE [validation](../../includes/mvc-intro/validation.md)]

> [!div class="step-by-step"]
> <span data-ttu-id="78269-103">[上一步 - 新增欄位](new-field.md)
> [下一步 - 檢查 Details 和 Delete 方法](xref:tutorials/first-mvc-app/details)</span><span class="sxs-lookup"><span data-stu-id="78269-103">[Previous - Add a field](new-field.md)
