...
---
<a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="2d488-102">ASP.NET Web Form 和 Ajax 4</span><span class="sxs-lookup"><span data-stu-id="2d488-102">ASP.NET Web Forms and Ajax 4</span></span>
====================
<span data-ttu-id="2d488-103">下列檔案裝載在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="2d488-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="2d488-104">注意： 全球化指令碼，例如 fr FR.js，可在下列資料夾：</span><span class="sxs-lookup"><span data-stu-id="2d488-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
