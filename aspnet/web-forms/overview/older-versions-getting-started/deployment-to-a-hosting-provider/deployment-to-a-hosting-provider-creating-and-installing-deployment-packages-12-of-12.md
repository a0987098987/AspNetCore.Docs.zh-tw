...
如需有關如何編輯資訊`PreSource`項目在專案檔中，請參閱[如何： 編輯專案檔中的部署設定](https://msdn.microsoft.com/en-us/library/ff398069(v=vs.100).aspx)。 如果需要會在目的地資料庫中的使用者或開發資料庫中的角色，請連絡您的主機服務提供者尋求協助。
