...
====================
<span data-ttu-id="78cb6-103">在 CDN 上裝載下列檔案：</span><span class="sxs-lookup"><span data-stu-id="78cb6-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="78cb6-104">注意： 全球化指令碼，例如 fr FR.js，可以找到下列資料夾中：</span><span class="sxs-lookup"><span data-stu-id="78cb6-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
