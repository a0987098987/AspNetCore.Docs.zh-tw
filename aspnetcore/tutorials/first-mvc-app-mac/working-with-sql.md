...
<span data-ttu-id="6050a-104">[上一步 - 新增模型](adding-model.md)
[下一步 - 控制器方法和檢視](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="6050a-104">[Previous - Add a model](adding-model.md)
