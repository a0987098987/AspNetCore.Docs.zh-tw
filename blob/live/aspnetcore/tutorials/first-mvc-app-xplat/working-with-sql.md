...
<span data-ttu-id="c11dc-103">[上一步 - 新增模型](adding-model.md)
[下一步 - 控制器方法和檢視](controller-methods-views.md)</span><span class="sxs-lookup"><span data-stu-id="c11dc-103">[Previous - Add a model](adding-model.md)
