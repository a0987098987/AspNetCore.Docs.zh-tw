...
ms.locfileid: "30070686"
---
<a name="aspnet-web-forms-and-ajax-4"></a><span data-ttu-id="d1dae-102">ASP.NET Web Form 和 Ajax 4</span><span class="sxs-lookup"><span data-stu-id="d1dae-102">ASP.NET Web Forms and Ajax 4</span></span>
====================
<span data-ttu-id="d1dae-103">在 CDN 上裝載下列檔案：</span><span class="sxs-lookup"><span data-stu-id="d1dae-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="d1dae-104">注意： 全球化指令碼，例如 fr FR.js，可以找到下列資料夾中：</span><span class="sxs-lookup"><span data-stu-id="d1dae-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
