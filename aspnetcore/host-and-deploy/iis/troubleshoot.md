...
* Azure App Service 也會使用 [ASP.NET Core 模組](xref:host-and-deploy/aspnet-core-module) 與 IIS 來裝載應用程式。 如需有關 Azure App Service 的疑難排解資訊，請參閱 <xref:host-and-deploy/azure-apps/troubleshoot>。
