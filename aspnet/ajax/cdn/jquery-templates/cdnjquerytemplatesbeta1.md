...
---
<a name="jquery-templates-beta-1"></a><span data-ttu-id="89495-102">jQuery 範本 Beta 1</span><span class="sxs-lookup"><span data-stu-id="89495-102">jQuery Templates Beta 1</span></span>
====================
<span data-ttu-id="89495-103">JQuery 範本外掛程式包含下列檔案：</span><span class="sxs-lookup"><span data-stu-id="89495-103">The jQuery Templates plugin includes the following files:</span></span>
