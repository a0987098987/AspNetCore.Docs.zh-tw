<span data-ttu-id="71b26-101">Visual Studio for Mac 會顯示一個含有下列訊息的對話方塊：</span><span class="sxs-lookup"><span data-stu-id="71b26-101">Visual Studio for Mac displays a dialog with the following message:</span></span>
