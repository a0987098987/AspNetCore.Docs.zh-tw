...
---
# <a name="testing-controller-logic-in-aspnet-core"></a>測試 ASP.NET Core 中的控制器邏輯
...
> [!TIP]
> [使用 Visual Studio 建立和執行單元測試](https://docs.microsoft.com/visualstudio/test/unit-test-your-code)。
