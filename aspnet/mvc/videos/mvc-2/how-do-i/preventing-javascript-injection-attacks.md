...
ms.locfileid: "37813496"
---
<a name="preventing-javascript-injection-attacks"></a>防止 JavaScript 插入式攻擊
====================
藉由[Stephen Walther](https://github.com/StephenWalther)

防止 JavaScript 插入式攻擊和跨網站指令攻擊發生給您。 在本教學課程中，Stephen Walther 會說明如何輕鬆地擊敗這些類型的 HTML 編碼內容的攻擊。 其他關於本影片的詳細資訊，請參閱 「 防止 JavaScript 插入式攻擊 」 教學課程 ([C#](../../../overview/older-versions-1/security/preventing-javascript-injection-attacks-cs.md)， [VB](../../../overview/older-versions-1/security/preventing-javascript-injection-attacks-vb.md))。
