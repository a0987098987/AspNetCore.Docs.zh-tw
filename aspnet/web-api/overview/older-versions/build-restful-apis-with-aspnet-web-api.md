...
<span data-ttu-id="baf18-144">在此練習中，您將連絡人的 manager 實作唯讀 GET 方法。</span><span class="sxs-lookup"><span data-stu-id="baf18-144">In this exercise, you will implement the read-only GET methods for the contact manager.</span></span>
...
<span data-ttu-id="baf18-158">在這項工作，您將建立應用程式開發介面方法所在的控制器類別。</span><span class="sxs-lookup"><span data-stu-id="baf18-158">In this task, you will create the controller classes in which API methods will reside.</span></span>
...
1. <span data-ttu-id="baf18-222">在方案根目錄中建立新的資料夾並將其命名**服務**。</span><span class="sxs-lookup"><span data-stu-id="baf18-222">Create a new folder in the solution root and name it **Services**.</span></span> <span data-ttu-id="baf18-223">若要這樣做，請以滑鼠右鍵按一下**ContactManager**專案，然後選取**新增** | **新資料夾**，其命名*服務*。</span><span class="sxs-lookup"><span data-stu-id="baf18-223">To do this, right-click **ContactManager** project, select **Add** | **New Folder**, name it *Services*.</span></span>
...
16. <span data-ttu-id="baf18-249">Visual Studio 2012 應該中斷一次**取得**方法就會開始執行。</span><span class="sxs-lookup"><span data-stu-id="baf18-249">Visual Studio 2012 should break once **Get** method begins execution.</span></span>
   ...
   <span data-ttu-id="baf18-251">*取得方法內中斷*</span><span class="sxs-lookup"><span data-stu-id="baf18-251">*Breaking within the Get method*</span></span>
...
<span data-ttu-id="baf18-264">在這項工作，您將準備增強，因此可接受使用者輸入，練習 1 中建立的 Web API 專案。</span><span class="sxs-lookup"><span data-stu-id="baf18-264">In this task, you will prepare to enhance the Web API project created in Exercise 1 so that it can accept user input.</span></span>
...
1. <span data-ttu-id="baf18-278">新增下列常數**ContactRepository**類別來代表 web 伺服器快取項目索引鍵名稱稍後在這個練習中的名稱。</span><span class="sxs-lookup"><span data-stu-id="baf18-278">Add the following constant to the **ContactRepository** class to represent the name of the web server cache item key name later in this exercise.</span></span>
...
<span data-ttu-id="baf18-359">*若要將程式碼插入您的專案中使用 Visual Studio 程式碼片段*</span><span class="sxs-lookup"><span data-stu-id="baf18-359">*Using Visual Studio code snippets to insert code into your project*</span></span>
...
1. <span data-ttu-id="baf18-373">以滑鼠右鍵按一下您要插入程式碼片段。</span><span class="sxs-lookup"><span data-stu-id="baf18-373">Right-click where you want to insert the code snippet.</span></span>
...
6. <span data-ttu-id="baf18-396">當安裝完成時，按一下**完成**。</span><span class="sxs-lookup"><span data-stu-id="baf18-396">When the installation completes, click **Finish**.</span></span>
    ...
    <span data-ttu-id="baf18-398">*安裝已完成*</span><span class="sxs-lookup"><span data-stu-id="baf18-398">*Installation completed*</span></span>
7. <span data-ttu-id="baf18-399">按一下**結束**關閉 Web Platform Installer。</span><span class="sxs-lookup"><span data-stu-id="baf18-399">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="baf18-400">若要開啟 Visual Studio Express for Web，請移至**啟動**畫面上，並開始書寫&quot; **VS Express**&quot;，然後按一下  **VS Express for Web**並排顯示。</span><span class="sxs-lookup"><span data-stu-id="baf18-400">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web 方塊](build-restful-apis-with-aspnet-web-api/_static/image38.png)

    <span data-ttu-id="baf18-402">*VS Express for Web 方塊*</span><span class="sxs-lookup"><span data-stu-id="baf18-402">*VS Express for Web tile*</span></span>

<a id="AppendixC"></a>

<a id="Appendix_C_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
## <a name="appendix-c-publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="baf18-403">附錄 c： 發佈 ASP.NET MVC 4 應用程式使用 Web Deploy</span><span class="sxs-lookup"><span data-stu-id="baf18-403">Appendix C: Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

<span data-ttu-id="baf18-404">此附錄將說明如何從 Azure 入口網站建立新的網站和發行您取得依照實驗室中，利用 Web Deploy 發行功能的 Azure 所提供的應用程式。</span><span class="sxs-lookup"><span data-stu-id="baf18-404">This appendix will show you how to create a new web site from the Azure Portal and publish the application you obtained by following the lab, taking advantage of the Web Deploy publishing feature provided by Azure.</span></span>

<a id="ApxCTask1"></a>

<a id="Task_1_-_Creating_a_New_Web_Site_from_the_Windows_Azure_Portal"></a>
#### <a name="task-1---creating-a-new-web-site-from-the-azure-portal"></a><span data-ttu-id="baf18-405">工作 1-從 Azure 入口網站建立新的網站</span><span class="sxs-lookup"><span data-stu-id="baf18-405">Task 1 - Creating a New Web Site from the Azure Portal</span></span>

1. <span data-ttu-id="baf18-406">移至[Azure 管理入口網站](https://manage.windowsazure.com/)並使用與您訂用帳戶相關聯的 Microsoft 認證登入。</span><span class="sxs-lookup"><span data-stu-id="baf18-406">Go to the [Azure Management Portal](https://manage.windowsazure.com/) and sign in using the Microsoft credentials associated with your subscription.</span></span>

    > [!NOTE]
    > <span data-ttu-id="baf18-407">使用 Azure 中，您可以免費裝載 10 個 ASP.NET 網站並再擴充隨流量成長。</span><span class="sxs-lookup"><span data-stu-id="baf18-407">With Azure you can host 10 ASP.NET Web Sites for free and then scale as your traffic grows.</span></span> <span data-ttu-id="baf18-408">您可以註冊[這裡](http://aka.ms/aspnet-hol-azure)。</span><span class="sxs-lookup"><span data-stu-id="baf18-408">You can sign up [here](http://aka.ms/aspnet-hol-azure).</span></span>

    <span data-ttu-id="baf18-409">![登入 Windows Azure 入口網站](build-restful-apis-with-aspnet-web-api/_static/image39.png "登入 Windows Azure 入口網站")</span><span class="sxs-lookup"><span data-stu-id="baf18-409">![Log on to Windows Azure portal](build-restful-apis-with-aspnet-web-api/_static/image39.png "Log on to Windows Azure portal")</span></span>

    <span data-ttu-id="baf18-410">*登入入口網站*</span><span class="sxs-lookup"><span data-stu-id="baf18-410">*Log on to Portal*</span></span>
2. <span data-ttu-id="baf18-411">按一下**新增**命令列上。</span><span class="sxs-lookup"><span data-stu-id="baf18-411">Click **New** on the command bar.</span></span>

    <span data-ttu-id="baf18-412">![建立新的網站](build-restful-apis-with-aspnet-web-api/_static/image40.png "建立新的網站")</span><span class="sxs-lookup"><span data-stu-id="baf18-412">![Creating a new Web Site](build-restful-apis-with-aspnet-web-api/_static/image40.png "Creating a new Web Site")</span></span>

    <span data-ttu-id="baf18-413">*建立新的網站*</span><span class="sxs-lookup"><span data-stu-id="baf18-413">*Creating a new Web Site*</span></span>
3. <span data-ttu-id="baf18-414">按一下**計算** | **網站**。</span><span class="sxs-lookup"><span data-stu-id="baf18-414">Click **Compute** | **Web Site**.</span></span> <span data-ttu-id="baf18-415">然後選取**快速建立**選項。</span><span class="sxs-lookup"><span data-stu-id="baf18-415">Then select **Quick Create** option.</span></span> <span data-ttu-id="baf18-416">新的網站上提供可用的 URL，然後按一下**建立網站**。</span><span class="sxs-lookup"><span data-stu-id="baf18-416">Provide an available URL for the new web site and click **Create Web Site**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="baf18-417">Azure 是您可以控制和管理在雲端中執行 web 應用程式的主機。</span><span class="sxs-lookup"><span data-stu-id="baf18-417">Azure is the host for a web application running in the cloud that you can control and manage.</span></span> <span data-ttu-id="baf18-418">快速建立 選項可讓您部署已完成的 web 應用程式，從 azure 入口網站外部。</span><span class="sxs-lookup"><span data-stu-id="baf18-418">The Quick Create option allows you to deploy a completed web application to the Azure from outside the portal.</span></span> <span data-ttu-id="baf18-419">它不包含設定資料庫的步驟。</span><span class="sxs-lookup"><span data-stu-id="baf18-419">It does not include steps for setting up a database.</span></span>

    <span data-ttu-id="baf18-420">![建立新的網站使用 快速建立](build-restful-apis-with-aspnet-web-api/_static/image41.png "建立新的網站使用 快速建立")</span><span class="sxs-lookup"><span data-stu-id="baf18-420">![Creating a new Web Site using Quick Create](build-restful-apis-with-aspnet-web-api/_static/image41.png "Creating a new Web Site using Quick Create")</span></span>

    <span data-ttu-id="baf18-421">*建立新的網站使用 快速建立*</span><span class="sxs-lookup"><span data-stu-id="baf18-421">*Creating a new Web Site using Quick Create*</span></span>
4. <span data-ttu-id="baf18-422">等候新**網站**建立。</span><span class="sxs-lookup"><span data-stu-id="baf18-422">Wait until the new **Web Site** is created.</span></span>
5. <span data-ttu-id="baf18-423">建立網站之後按一下底下的連結**URL**資料行。</span><span class="sxs-lookup"><span data-stu-id="baf18-423">Once the Web Site is created click the link under the **URL** column.</span></span> <span data-ttu-id="baf18-424">請檢查新的網站運作。</span><span class="sxs-lookup"><span data-stu-id="baf18-424">Check that the new Web Site is working.</span></span>

    <span data-ttu-id="baf18-425">![瀏覽至新的網站](build-restful-apis-with-aspnet-web-api/_static/image42.png "瀏覽至新的網站")</span><span class="sxs-lookup"><span data-stu-id="baf18-425">![Browsing to the new web site](build-restful-apis-with-aspnet-web-api/_static/image42.png "Browsing to the new web site")</span></span>

    <span data-ttu-id="baf18-426">*瀏覽至新的網站*</span><span class="sxs-lookup"><span data-stu-id="baf18-426">*Browsing to the new web site*</span></span>

    <span data-ttu-id="baf18-427">![執行網站](build-restful-apis-with-aspnet-web-api/_static/image43.png "執行的網站")</span><span class="sxs-lookup"><span data-stu-id="baf18-427">![Web site running](build-restful-apis-with-aspnet-web-api/_static/image43.png "Web site running")</span></span>

    <span data-ttu-id="baf18-428">*執行的網站*</span><span class="sxs-lookup"><span data-stu-id="baf18-428">*Web site running*</span></span>
6. <span data-ttu-id="baf18-429">返回入口網站並按一下底下的網站名稱**名稱**資料行會顯示 [管理] 頁面。</span><span class="sxs-lookup"><span data-stu-id="baf18-429">Go back to the portal and click the name of the web site under the **Name** column to display the management pages.</span></span>

    <span data-ttu-id="baf18-430">![開啟網站管理頁面](build-restful-apis-with-aspnet-web-api/_static/image44.png "開啟網站管理頁面")</span><span class="sxs-lookup"><span data-stu-id="baf18-430">![Opening the web site management pages](build-restful-apis-with-aspnet-web-api/_static/image44.png "Opening the web site management pages")</span></span>

    <span data-ttu-id="baf18-431">*開啟網站管理頁面*</span><span class="sxs-lookup"><span data-stu-id="baf18-431">*Opening the Web Site management pages*</span></span>
7. <span data-ttu-id="baf18-432">在**儀表板**頁面的 **快速概覽**區段中，按一下**下載發行設定檔**連結。</span><span class="sxs-lookup"><span data-stu-id="baf18-432">In the **Dashboard** page, under the **quick glance** section, click the **Download publish profile** link.</span></span>

    > [!NOTE]
    > <span data-ttu-id="baf18-433">*發行設定檔*包含所有 web 應用程式發行至 Azure 的每個已啟用的發行方法所需的資訊。</span><span class="sxs-lookup"><span data-stu-id="baf18-433">The *publish profile* contains all of the information required to publish a web application to a Azure for each enabled publication method.</span></span> <span data-ttu-id="baf18-434">發行設定檔包含 Url、 使用者認證和資料庫連接，並對每個端點已啟用的發行集的方法進行驗證所需的字串。</span><span class="sxs-lookup"><span data-stu-id="baf18-434">The publish profile contains the URLs, user credentials and database strings required to connect to and authenticate against each of the endpoints for which a publication method is enabled.</span></span> <span data-ttu-id="baf18-435">**Microsoft WebMatrix 2**， **Microsoft Visual Studio Express for Web**和**Microsoft Visual Studio 2012**支援讀取發行設定檔自動將這些程式的組態web 應用程式發行至 Azure。</span><span class="sxs-lookup"><span data-stu-id="baf18-435">**Microsoft WebMatrix 2**, **Microsoft Visual Studio Express for Web** and **Microsoft Visual Studio 2012** support reading publish profiles to automate configuration of these programs for publishing web applications to Azure.</span></span>

    <span data-ttu-id="baf18-436">![下載網站發行設定檔](build-restful-apis-with-aspnet-web-api/_static/image45.png "下載網站發行設定檔")</span><span class="sxs-lookup"><span data-stu-id="baf18-436">![Downloading the web site publish profile](build-restful-apis-with-aspnet-web-api/_static/image45.png "Downloading the web site publish profile")</span></span>

    <span data-ttu-id="baf18-437">*下載網站發行設定檔*</span><span class="sxs-lookup"><span data-stu-id="baf18-437">*Downloading the Web Site publish profile*</span></span>
8. <span data-ttu-id="baf18-438">下載發行設定檔至已知位置。</span><span class="sxs-lookup"><span data-stu-id="baf18-438">Download the publish profile file to a known location.</span></span> <span data-ttu-id="baf18-439">進一步在這個練習中，您會看到如何使用此檔案發行至 Azure 從 Visual Studio web 應用程式。</span><span class="sxs-lookup"><span data-stu-id="baf18-439">Further in this exercise you will see how to use this file to publish a web application to Azure from Visual Studio.</span></span>

    <span data-ttu-id="baf18-440">![儲存發行設定檔](build-restful-apis-with-aspnet-web-api/_static/image46.png "儲存發行設定檔")</span><span class="sxs-lookup"><span data-stu-id="baf18-440">![Saving the publish profile file](build-restful-apis-with-aspnet-web-api/_static/image46.png "Saving the publish profile")</span></span>

    <span data-ttu-id="baf18-441">*儲存發行設定檔*</span><span class="sxs-lookup"><span data-stu-id="baf18-441">*Saving the publish profile file*</span></span>

<a id="ApxCTask2"></a>

<a id="Task_2_-_Configuring_the_Database_Server"></a>
#### <a name="task-2---configuring-the-database-server"></a><span data-ttu-id="baf18-442">工作 2-設定資料庫伺服器</span><span class="sxs-lookup"><span data-stu-id="baf18-442">Task 2 - Configuring the Database Server</span></span>

<span data-ttu-id="baf18-443">如果您的應用程式會使用 SQL Server 資料庫，您必須建立 SQL Database 伺服器。</span><span class="sxs-lookup"><span data-stu-id="baf18-443">If your application makes use of SQL Server databases you will need to create a SQL Database server.</span></span> <span data-ttu-id="baf18-444">如果您想要部署簡單的應用程式不會使用 SQL Server，您可能會略過這項工作。</span><span class="sxs-lookup"><span data-stu-id="baf18-444">If you want to deploy a simple application that does not use SQL Server you might skip this task.</span></span>

1. <span data-ttu-id="baf18-445">您將需要 SQL Database 伺服器來儲存應用程式資料庫。</span><span class="sxs-lookup"><span data-stu-id="baf18-445">You will need a SQL Database server for storing the application database.</span></span> <span data-ttu-id="baf18-446">您可以從您的訂用帳戶，在 Azure 管理入口網站中檢視 SQL Database 伺服器**Sql 資料庫** | **伺服器** | **伺服器的儀表板**.</span><span class="sxs-lookup"><span data-stu-id="baf18-446">You can view the SQL Database servers from your subscription in the Azure Management portal at **Sql Databases** | **Servers** | **Server's Dashboard**.</span></span> <span data-ttu-id="baf18-447">如果您沒有建立伺服器，您可以建立一個使用**新增**命令列上的按鈕。</span><span class="sxs-lookup"><span data-stu-id="baf18-447">If you do not have a server created, you can create one using the **Add** button on the command bar.</span></span> <span data-ttu-id="baf18-448">請注意**伺服器名稱和 URL、 系統管理員身分登入名稱和密碼**，因為您將在下一個工作中使用它們。</span><span class="sxs-lookup"><span data-stu-id="baf18-448">Take note of the **server name and URL, administrator login name and password**, as you will use them in the next tasks.</span></span> <span data-ttu-id="baf18-449">並未建立資料庫，因為它會在後續階段中建立。</span><span class="sxs-lookup"><span data-stu-id="baf18-449">Do not create the database yet, as it will be created in a later stage.</span></span>

    <span data-ttu-id="baf18-450">![SQL Database 伺服器儀表板](build-restful-apis-with-aspnet-web-api/_static/image47.png "SQL Database 伺服器儀表板")</span><span class="sxs-lookup"><span data-stu-id="baf18-450">![SQL Database Server Dashboard](build-restful-apis-with-aspnet-web-api/_static/image47.png "SQL Database Server Dashboard")</span></span>

    <span data-ttu-id="baf18-451">*SQL Database 伺服器儀表板*</span><span class="sxs-lookup"><span data-stu-id="baf18-451">*SQL Database Server Dashboard*</span></span>
2. <span data-ttu-id="baf18-452">下一項工作在您將測試資料庫連接，從 Visual Studio，因此您需要在伺服器的清單中包含您的本機 IP 位址**允許的 IP 位址**。</span><span class="sxs-lookup"><span data-stu-id="baf18-452">In the next task you will test the database connection from Visual Studio, for that reason you need to include your local IP address in the server's list of **Allowed IP Addresses**.</span></span> <span data-ttu-id="baf18-453">若要這樣做，請按一下**設定**，選取 [IP 位址從**目前的用戶端 IP 位址**並將它貼上**起始 IP 位址**和**結束 IP 位址**文字方塊，然後按一下![add-client-ip-address-ok-button](build-restful-apis-with-aspnet-web-api/_static/image48.png) ] 按鈕。</span><span class="sxs-lookup"><span data-stu-id="baf18-453">To do that, click **Configure**, select the IP address from **Current Client IP Address** and paste it on the **Start IP Address** and **End IP Address** text boxes and click the ![add-client-ip-address-ok-button](build-restful-apis-with-aspnet-web-api/_static/image48.png) button.</span></span>

    ![加入用戶端 IP 位址](build-restful-apis-with-aspnet-web-api/_static/image49.png)

    <span data-ttu-id="baf18-455">*加入用戶端 IP 位址*</span><span class="sxs-lookup"><span data-stu-id="baf18-455">*Adding Client IP Address*</span></span>
3. <span data-ttu-id="baf18-456">一次**用戶端 IP 位址**新增至允許的 IP 位址清單中，按一下**儲存**來確認變更。</span><span class="sxs-lookup"><span data-stu-id="baf18-456">Once the **Client IP Address** is added to the allowed IP addresses list, click on **Save** to confirm the changes.</span></span>

    ![確認變更](build-restful-apis-with-aspnet-web-api/_static/image50.png)

    <span data-ttu-id="baf18-458">*確認變更*</span><span class="sxs-lookup"><span data-stu-id="baf18-458">*Confirm Changes*</span></span>

<a id="ApxCTask3"></a>

<a id="Task_3_-_Publishing_an_ASPNET_MVC_4_Application_using_Web_Deploy"></a>
#### <a name="task-3---publishing-an-aspnet-mvc-4-application-using-web-deploy"></a><span data-ttu-id="baf18-459">工作 3-發行 ASP.NET MVC 4 應用程式使用 Web Deploy</span><span class="sxs-lookup"><span data-stu-id="baf18-459">Task 3 - Publishing an ASP.NET MVC 4 Application using Web Deploy</span></span>

1. <span data-ttu-id="baf18-460">返回至 ASP.NET MVC 4 方案。</span><span class="sxs-lookup"><span data-stu-id="baf18-460">Go back to the ASP.NET MVC 4 solution.</span></span> <span data-ttu-id="baf18-461">在**方案總管 中**，以滑鼠右鍵按一下網站專案，然後選取**發行**。</span><span class="sxs-lookup"><span data-stu-id="baf18-461">In the **Solution Explorer**, right-click the web site project and select **Publish**.</span></span>

    <span data-ttu-id="baf18-462">![發行應用程式](build-restful-apis-with-aspnet-web-api/_static/image51.png "發行應用程式")</span><span class="sxs-lookup"><span data-stu-id="baf18-462">![Publishing the Application](build-restful-apis-with-aspnet-web-api/_static/image51.png "Publishing the Application")</span></span>

    <span data-ttu-id="baf18-463">*發行網站*</span><span class="sxs-lookup"><span data-stu-id="baf18-463">*Publishing the web site*</span></span>
2. <span data-ttu-id="baf18-464">匯入發行設定檔儲存在第一項工作中。</span><span class="sxs-lookup"><span data-stu-id="baf18-464">Import the publish profile you saved in the first task.</span></span>

    <span data-ttu-id="baf18-465">![匯入發行設定檔](build-restful-apis-with-aspnet-web-api/_static/image52.png "匯入發行設定檔")</span><span class="sxs-lookup"><span data-stu-id="baf18-465">![Importing the publish profile](build-restful-apis-with-aspnet-web-api/_static/image52.png "Importing the publish profile")</span></span>

    <span data-ttu-id="baf18-466">*匯入發行設定檔*</span><span class="sxs-lookup"><span data-stu-id="baf18-466">*Importing publish profile*</span></span>
3. <span data-ttu-id="baf18-467">按一下**驗證連線**。</span><span class="sxs-lookup"><span data-stu-id="baf18-467">Click **Validate Connection**.</span></span> <span data-ttu-id="baf18-468">驗證完成後按一下**下一步**。</span><span class="sxs-lookup"><span data-stu-id="baf18-468">Once Validation is complete click **Next**.</span></span>

    > [!NOTE]
    > <span data-ttu-id="baf18-469">一旦您看到 [驗證連線] 按鈕旁邊會出現綠色核取記號完成驗證。</span><span class="sxs-lookup"><span data-stu-id="baf18-469">Validation is complete once you see a green checkmark appear next to the Validate Connection button.</span></span>

    <span data-ttu-id="baf18-470">![驗證連線](build-restful-apis-with-aspnet-web-api/_static/image53.png "驗證連線")</span><span class="sxs-lookup"><span data-stu-id="baf18-470">![Validating connection](build-restful-apis-with-aspnet-web-api/_static/image53.png "Validating connection")</span></span>

    <span data-ttu-id="baf18-471">*驗證連接*</span><span class="sxs-lookup"><span data-stu-id="baf18-471">*Validating connection*</span></span>
4. <span data-ttu-id="baf18-472">在**設定**頁面的 **資料庫**區段中，按一下您的資料庫連接文字方塊旁邊的按鈕 (也就是**DefaultConnection**)。</span><span class="sxs-lookup"><span data-stu-id="baf18-472">In the **Settings** page, under the **Databases** section, click the button next to your database connection's textbox (i.e. **DefaultConnection**).</span></span>

    <span data-ttu-id="baf18-473">![Web 部署設定](build-restful-apis-with-aspnet-web-api/_static/image54.png "Web 部署設定")</span><span class="sxs-lookup"><span data-stu-id="baf18-473">![Web deploy configuration](build-restful-apis-with-aspnet-web-api/_static/image54.png "Web deploy configuration")</span></span>

    <span data-ttu-id="baf18-474">*Web 部署設定*</span><span class="sxs-lookup"><span data-stu-id="baf18-474">*Web deploy configuration*</span></span>
5. <span data-ttu-id="baf18-475">設定資料庫連接，如下所示：</span><span class="sxs-lookup"><span data-stu-id="baf18-475">Configure the database connection as follows:</span></span>

   - <span data-ttu-id="baf18-476">在**伺服器名稱**您 SQL Database 伺服器 URL 使用下列方法類型*tcp:*前置詞。</span><span class="sxs-lookup"><span data-stu-id="baf18-476">In the **Server name** type your SQL Database server URL using the *tcp:* prefix.</span></span>
   - <span data-ttu-id="baf18-477">在**使用者名**輸入您的伺服器系統管理員身分登入名稱。</span><span class="sxs-lookup"><span data-stu-id="baf18-477">In **User name** type your server administrator login name.</span></span>
   - <span data-ttu-id="baf18-478">在**密碼**輸入伺服器系統管理員身分登入密碼。</span><span class="sxs-lookup"><span data-stu-id="baf18-478">In **Password** type your server administrator login password.</span></span>
   - <span data-ttu-id="baf18-479">輸入新的資料庫名稱，例如： *MVC4SampleDB*。</span><span class="sxs-lookup"><span data-stu-id="baf18-479">Type a new database name, for example: *MVC4SampleDB*.</span></span>

     <span data-ttu-id="baf18-480">![設定目的地連接字串](build-restful-apis-with-aspnet-web-api/_static/image55.png "設定目的地連接字串")</span><span class="sxs-lookup"><span data-stu-id="baf18-480">![Configuring destination connection string](build-restful-apis-with-aspnet-web-api/_static/image55.png "Configuring destination connection string")</span></span>

     <span data-ttu-id="baf18-481">*設定目的地連接字串*</span><span class="sxs-lookup"><span data-stu-id="baf18-481">*Configuring destination connection string*</span></span>
6. <span data-ttu-id="baf18-482">然後按一下 [確定]。 </span><span class="sxs-lookup"><span data-stu-id="baf18-482">Then click **OK**.</span></span> <span data-ttu-id="baf18-483">當系統提示您建立資料庫依序按一下**是**。</span><span class="sxs-lookup"><span data-stu-id="baf18-483">When prompted to create the database click **Yes**.</span></span>

    <span data-ttu-id="baf18-484">![建立資料庫](build-restful-apis-with-aspnet-web-api/_static/image56.png "建立的資料庫字串")</span><span class="sxs-lookup"><span data-stu-id="baf18-484">![Creating the database](build-restful-apis-with-aspnet-web-api/_static/image56.png "Creating the database string")</span></span>

    <span data-ttu-id="baf18-485">*建立資料庫*</span><span class="sxs-lookup"><span data-stu-id="baf18-485">*Creating the database*</span></span>
7. <span data-ttu-id="baf18-486">您將用來連接到在 Windows Azure SQL Database 的連接字串會顯示在預設連接文字方塊中。</span><span class="sxs-lookup"><span data-stu-id="baf18-486">The connection string you will use to connect to SQL Database in Windows Azure is shown within Default Connection textbox.</span></span> <span data-ttu-id="baf18-487">然後按 [下一步] 。</span><span class="sxs-lookup"><span data-stu-id="baf18-487">Then click **Next**.</span></span>

    <span data-ttu-id="baf18-488">![連接字串指向 SQL Database](build-restful-apis-with-aspnet-web-api/_static/image57.png "連接字串指向 SQL 資料庫")</span><span class="sxs-lookup"><span data-stu-id="baf18-488">![Connection string pointing to SQL Database](build-restful-apis-with-aspnet-web-api/_static/image57.png "Connection string pointing to SQL Database")</span></span>

    <span data-ttu-id="baf18-489">*連接字串指向 SQL 資料庫*</span><span class="sxs-lookup"><span data-stu-id="baf18-489">*Connection string pointing to SQL Database*</span></span>
8. <span data-ttu-id="baf18-490">在**預覽**頁面上，按一下**發行**。</span><span class="sxs-lookup"><span data-stu-id="baf18-490">In the **Preview** page, click **Publish**.</span></span>

    <span data-ttu-id="baf18-491">![Web 應用程式發行](build-restful-apis-with-aspnet-web-api/_static/image58.png "發行 web 應用程式")</span><span class="sxs-lookup"><span data-stu-id="baf18-491">![Publishing the web application](build-restful-apis-with-aspnet-web-api/_static/image58.png "Publishing the web application")</span></span>

    <span data-ttu-id="baf18-492">*發行 web 應用程式*</span><span class="sxs-lookup"><span data-stu-id="baf18-492">*Publishing the web application*</span></span>
9. <span data-ttu-id="baf18-493">一旦在發佈程序完成時，預設瀏覽器會開啟已發行的網站。</span><span class="sxs-lookup"><span data-stu-id="baf18-493">Once the publishing process finishes, your default browser will open the published web site.</span></span>

    <span data-ttu-id="baf18-494">![應用程式發行至 Windows Azure](build-restful-apis-with-aspnet-web-api/_static/image59.png "應用程式發行至 Windows Azure")</span><span class="sxs-lookup"><span data-stu-id="baf18-494">![Application published to Windows Azure](build-restful-apis-with-aspnet-web-api/_static/image59.png "Application published to Windows Azure")</span></span>

    <span data-ttu-id="baf18-495">*應用程式發行至 Azure*</span><span class="sxs-lookup"><span data-stu-id="baf18-495">*Application published to Azure*</span></span>
