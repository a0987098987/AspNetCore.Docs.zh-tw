...
## <a name="recommendations-for-use-in-apps"></a><span data-ttu-id="d1b8f-183">建議以供在應用程式中使用</span><span class="sxs-lookup"><span data-stu-id="d1b8f-183">Recommendations for use in apps</span></span>
