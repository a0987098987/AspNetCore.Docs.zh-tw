...
ms.locfileid: "30071268"
---
<a name="aspnet-web-forms-and-ajax-452"></a><span data-ttu-id="cbb3f-102">ASP.NET Web Form 和 Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="cbb3f-102">ASP.NET Web Forms and Ajax 4.5.2</span></span>
====================
<span data-ttu-id="cbb3f-103">在 CDN 上裝載下列檔案：</span><span class="sxs-lookup"><span data-stu-id="cbb3f-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="cbb3f-104">注意： 全球化指令碼，例如 fr FR.js，可以找到下列資料夾中：</span><span class="sxs-lookup"><span data-stu-id="cbb3f-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
