...
<span data-ttu-id="c8fc7-113">最後，您將會讓使用者可以刪除專輯和您將會防止使用者從輸入錯誤的資料來驗證其輸入。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-113">Lastly, you will let users delete an album and also you will prevent them from entering wrong data by validating their input.</span></span>
...
<span data-ttu-id="c8fc7-130">您必須具備下列項目才能完成本實驗室：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-130">You must have the following items to complete this lab:</span></span>
...
3. <span data-ttu-id="c8fc7-187">在 [新增檢視] 對話方塊中，確認檢視表名稱為**索引**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-187">In the Add View dialog, verify that the View Name is **Index**.</span></span> <span data-ttu-id="c8fc7-188">選取**建立強型別檢視**選項，然後選取**專輯 (MvcMusicStore.Models)**從**模型類別**下拉式清單。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-188">Select the **Create a strongly-typed view** option, and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="c8fc7-189">選取**清單**從**Scaffold 範本**下拉式清單。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-189">Select **List** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="c8fc7-190">保留**檢視引擎**至**Razor** ，其預設值的其他欄位值，然後按**新增**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-190">Leave the **View engine** to **Razor** and the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="c8fc7-191">![加入索引檢視](aspnet-mvc-4-helpers-forms-and-validation/_static/image3.png "加入索引檢視")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-191">![Adding an index view](aspnet-mvc-4-helpers-forms-and-validation/_static/image3.png "Adding an index view")</span></span>
...
2. <span data-ttu-id="c8fc7-275">在 [新增檢視] 對話方塊中，確認檢視表名稱為**編輯**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-275">In the Add View dialog, verify that the View Name is **Edit**.</span></span> <span data-ttu-id="c8fc7-276">請檢查**建立強型別檢視**核取方塊並選取**專輯 (MvcMusicStore.Models)**從**檢視資料類別**下拉式清單。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-276">Check the **Create a strongly-typed view** checkbox and select **Album (MvcMusicStore.Models)** from the **View data class** drop-down.</span></span> <span data-ttu-id="c8fc7-277">選取**編輯**從**Scaffold 範本**下拉式清單。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-277">Select **Edit** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="c8fc7-278">保留其他欄位的預設值，然後按**新增**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-278">Leave the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="c8fc7-279">![加入編輯檢視](aspnet-mvc-4-helpers-forms-and-validation/_static/image7.png "加入編輯檢視")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-279">![Adding an Edit view](aspnet-mvc-4-helpers-forms-and-validation/_static/image7.png "Adding an Edit view")</span></span>
...
2. <span data-ttu-id="c8fc7-320">在首頁上，啟動專案。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-320">The project starts in the Home page.</span></span> <span data-ttu-id="c8fc7-321">將 URL 變更為**/StoreManager/Edit/1**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-321">Change the URL to **/StoreManager/Edit/1**.</span></span> <span data-ttu-id="c8fc7-322">將專輯標題來變更**負載**，然後按一下 **儲存**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-322">Change the Album title to **Load** and click on **Save**.</span></span> <span data-ttu-id="c8fc7-323">請確認專輯標題實際變更清單中的專輯。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-323">Verify that album's title actually changed in the list of albums.</span></span>
    ...
    <span data-ttu-id="c8fc7-324">![更新專輯](aspnet-mvc-4-helpers-forms-and-validation/_static/image10.png "更新相簿")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-324">![Updating an album](aspnet-mvc-4-helpers-forms-and-validation/_static/image10.png "Updating an album")</span></span>
...
2. <span data-ttu-id="c8fc7-350">在 [新增檢視] 對話方塊中，確認檢視表名稱為**建立**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-350">In the Add View dialog, verify that the View Name is **Create**.</span></span> <span data-ttu-id="c8fc7-351">選取**建立強型別檢視**選項，然後選取**專輯 (MvcMusicStore.Models)**從**模型類別**下拉式清單和**建立**從**Scaffold 範本**下拉式清單。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-351">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down and **Create** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="c8fc7-352">保留其他欄位的預設值，然後按**新增**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-352">Leave the other fields with their default value and then click **Add**.</span></span>
    ...
    <span data-ttu-id="c8fc7-354">*加入建立檢視*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-354">*Adding the Create View*</span></span>
...
2. <span data-ttu-id="c8fc7-370">取代**HTTP POST 建立**動作方法的程式碼以下列：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-370">Replace **HTTP-POST Create** action method code with the following:</span></span>
    ...
    <span data-ttu-id="c8fc7-371">(程式碼片段- *ASP.NET MVC 4 Helper 和表單驗證-Ex4 StoreManagerController HTTP POST 建立動作*)</span><span class="sxs-lookup"><span data-stu-id="c8fc7-371">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex4 StoreManagerController HTTP- POST Create action*)</span></span>
...
2. <span data-ttu-id="c8fc7-401">開啟**StoreManagerController**類別。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-401">Open **StoreManagerController** class.</span></span> <span data-ttu-id="c8fc7-402">若要這樣做，請展開**控制器**資料夾，然後按兩下**StoreManagerController.cs**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-402">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
3. <span data-ttu-id="c8fc7-403">刪除控制器動作正是先前存放區詳細資料控制器動作相同： 它會查詢**專輯**物件從資料庫使用**識別碼**中提供 URL 與傳回適當**檢視**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-403">The Delete controller action is exactly the same as the previous Store Details controller action: it queries the **album** object from the database using the **id** provided in the URL and returns the appropriate **View**.</span></span> <span data-ttu-id="c8fc7-404">若要這樣做，取代 HTTP GET**刪除**動作方法的程式碼以下列：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-404">To do this, replace the HTTP-GET **Delete** action method code with the following:</span></span>

    <span data-ttu-id="c8fc7-405">(程式碼片段- *ASP.NET MVC 4 Helper 和表單驗證-Ex5 處理刪除 HTTP-GET 刪除動作*)</span><span class="sxs-lookup"><span data-stu-id="c8fc7-405">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-GET Delete action*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample15.cs)]
4. <span data-ttu-id="c8fc7-406">以滑鼠右鍵按一下**刪除**動作方法，然後選取**加入檢視**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-406">Right-click inside the **Delete** action method and select **Add View**.</span></span> <span data-ttu-id="c8fc7-407">這會顯示 [新增檢視] 對話方塊。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-407">This will bring up the Add View dialog.</span></span>
5. <span data-ttu-id="c8fc7-408">在 [新增檢視] 對話方塊中，確認檢視表名稱為**刪除**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-408">In the Add View dialog, verify that the View name is **Delete**.</span></span> <span data-ttu-id="c8fc7-409">選取**建立強型別檢視**選項，然後選取**專輯 (MvcMusicStore.Models)**從**模型類別**下拉式清單。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-409">Select the **Create a strongly-typed view** option and select **Album (MvcMusicStore.Models)** from the **Model class** drop-down.</span></span> <span data-ttu-id="c8fc7-410">選取**刪除**從**Scaffold 範本**下拉式清單。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-410">Select **Delete** from the **Scaffold template** drop-down.</span></span> <span data-ttu-id="c8fc7-411">保留其他欄位的預設值，然後按**新增**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-411">Leave the other fields with their default value and then click **Add**.</span></span>

    <span data-ttu-id="c8fc7-412">![加入刪除檢視](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "加入刪除檢視")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-412">![Adding a Delete View](aspnet-mvc-4-helpers-forms-and-validation/_static/image15.png "Adding a Delete View")</span></span>

    <span data-ttu-id="c8fc7-413">*加入刪除檢視*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-413">*Adding a Delete View*</span></span>
6. <span data-ttu-id="c8fc7-414">刪除範本會顯示模型中的所有欄位。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-414">The Delete template shows all the fields from the model.</span></span> <span data-ttu-id="c8fc7-415">您將會顯示只有專輯標題。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-415">You will show only the album's title.</span></span> <span data-ttu-id="c8fc7-416">若要這樣做，請取代下列程式碼中檢視的內容：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-416">To do this, replace the content of the view with the following code:</span></span>
...
#### <a name="task-2---running-the-application"></a><span data-ttu-id="c8fc7-417">工作 2-執行應用程式</span><span class="sxs-lookup"><span data-stu-id="c8fc7-417">Task 2 - Running the Application</span></span>

<span data-ttu-id="c8fc7-418">在這個工作中，您將測試的**StoreManager** **刪除**檢視頁面會顯示確認刪除表單。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-418">In this task, you will test that the **StoreManager** **Delete** View page displays a confirmation deletion form.</span></span>

1. <span data-ttu-id="c8fc7-419">按**F5**執行應用程式。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-419">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="c8fc7-420">在首頁上，啟動專案。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-420">The project starts in the Home page.</span></span> <span data-ttu-id="c8fc7-421">將 URL 變更為**/StoreManager**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-421">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="c8fc7-422">選取即可刪除一個專輯**刪除**並驗證已上傳新的檢視。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-422">Select one album to delete by clicking **Delete** and verify that the new view is uploaded.</span></span>

    <span data-ttu-id="c8fc7-423">![刪除相簿](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "刪除相簿")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-423">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image16.png "Deleting an Album")</span></span>

    <span data-ttu-id="c8fc7-424">*刪除相簿*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-424">*Deleting an Album*</span></span>

<a id="Ex05Task3"></a>

<a id="Task_3-_Implementing_the_HTTP-POST_Delete_Action_Method"></a>
#### <a name="task-3--implementing-the-http-post-delete-action-method"></a><span data-ttu-id="c8fc7-425">工作 3-實作 HTTP POST 的 Delete 動作方法</span><span class="sxs-lookup"><span data-stu-id="c8fc7-425">Task 3- Implementing the HTTP-POST Delete Action Method</span></span>

<span data-ttu-id="c8fc7-426">在這個工作中，您將實作當使用者按一下就會叫用的 Delete 動作方法的 HTTP POST 新版**刪除** 按鈕。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-426">In this task, you will implement the HTTP-POST version of the Delete action method that will be invoked when a user clicks the **Delete** button.</span></span> <span data-ttu-id="c8fc7-427">此方法應該刪除資料庫中的專輯。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-427">The method should delete the album in the database.</span></span>

1. <span data-ttu-id="c8fc7-428">關閉瀏覽器，如有需要若要返回 Visual Studio 視窗。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-428">Close the browser if needed, to return to the Visual Studio window.</span></span> <span data-ttu-id="c8fc7-429">開啟**StoreManagerController**類別。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-429">Open **StoreManagerController** class.</span></span> <span data-ttu-id="c8fc7-430">若要這樣做，請展開**控制器**資料夾，然後按兩下**StoreManagerController.cs**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-430">To do this, expand the **Controllers** folder and double-click **StoreManagerController.cs**.</span></span>
2. <span data-ttu-id="c8fc7-431">取代**HTTP POST 刪除**動作方法的程式碼以下列：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-431">Replace **HTTP-POST Delete** action method code with the following:</span></span>

    <span data-ttu-id="c8fc7-432">(程式碼片段- *ASP.NET MVC 4 Helper 和表單驗證-Ex5 處理刪除 HTTP POST 刪除動作*)</span><span class="sxs-lookup"><span data-stu-id="c8fc7-432">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex5 Handling Deletion HTTP-POST Delete action*)</span></span>
...
#### <a name="task-4---running-the-application"></a><span data-ttu-id="c8fc7-433">工作 4-執行應用程式</span><span class="sxs-lookup"><span data-stu-id="c8fc7-433">Task 4 - Running the Application</span></span>

<span data-ttu-id="c8fc7-434">在這個工作中，您將測試的**StoreManager 刪除**檢視頁面可讓您刪除相簿，然後重新導向至 StoreManager 索引檢視。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-434">In this task, you will test that the **StoreManager Delete** View page lets you delete an Album and then redirects to the StoreManager Index View.</span></span>

1. <span data-ttu-id="c8fc7-435">按**F5**執行應用程式。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-435">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="c8fc7-436">在首頁上，啟動專案。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-436">The project starts in the Home page.</span></span> <span data-ttu-id="c8fc7-437">將 URL 變更為**/StoreManager**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-437">Change the URL to **/StoreManager**.</span></span> <span data-ttu-id="c8fc7-438">選取即可刪除一個專輯**刪除。**</span><span class="sxs-lookup"><span data-stu-id="c8fc7-438">Select one album to delete by clicking **Delete.**</span></span> <span data-ttu-id="c8fc7-439">按一下以確認刪除動作**刪除**按鈕：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-439">Confirm the deletion by clicking **Delete** button:</span></span>

    <span data-ttu-id="c8fc7-440">![刪除相簿](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "刪除相簿")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-440">![Deleting an Album](aspnet-mvc-4-helpers-forms-and-validation/_static/image17.png "Deleting an Album")</span></span>

    <span data-ttu-id="c8fc7-441">*刪除相簿*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-441">*Deleting an Album*</span></span>
3. <span data-ttu-id="c8fc7-442">確認已刪除的專輯，因為它不會顯示在**索引**頁面。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-442">Verify that the album was deleted since it does not appear in the **Index** page.</span></span>

<a id="Exercise6"></a>

<a id="Exercise_6_Adding_Validation"></a>
### <a name="exercise-6-adding-validation"></a><span data-ttu-id="c8fc7-443">練習 6： 加入驗證</span><span class="sxs-lookup"><span data-stu-id="c8fc7-443">Exercise 6: Adding Validation</span></span>

<span data-ttu-id="c8fc7-444">目前，您已備妥的建立與編輯表單不會執行任何一種驗證。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-444">Currently, the Create and Edit forms you have in place do not perform any kind of validation.</span></span> <span data-ttu-id="c8fc7-445">如果使用者必要的欄位空白或型別字母離開 [價格] 欄位中，就會在第一個錯誤將會從資料庫中。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-445">If the user leaves a required field blank or type letters in the price field, the first error you will get will be from the database.</span></span>

<span data-ttu-id="c8fc7-446">您可以加入至應用程式的驗證，將資料註解加入至您的模型類別。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-446">You can add validation to the application by adding Data Annotations to your model class.</span></span> <span data-ttu-id="c8fc7-447">資料註解允許描述您想要套用至您的模型內容的規則和 ASP.NET MVC 會負責強制執行和顯示適當的訊息給使用者。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-447">Data Annotations allow describing the rules you want applied to your model properties, and ASP.NET MVC will take care of enforcing and displaying appropriate message to users.</span></span>

<a id="Ex06Task1"></a>

<a id="Task_1_-_Adding_Data_Annotations"></a>
#### <a name="task-1---adding-data-annotations"></a><span data-ttu-id="c8fc7-448">工作 1-新增資料註解</span><span class="sxs-lookup"><span data-stu-id="c8fc7-448">Task 1 - Adding Data Annotations</span></span>

<span data-ttu-id="c8fc7-449">在這項工作，您將加入資料註解專輯模型，可讓建立與編輯頁面顯示時適當的驗證訊息。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-449">In this task, you will add Data Annotations to the Album Model that will make the Create and Edit page display validation messages when appropriate.</span></span>

<span data-ttu-id="c8fc7-450">針對簡單的模型類別，加入資料註解只處理所加入**使用**陳述式**System.ComponentModel.DataAnnotation**，然後放置**[必要]**上適當的內容屬性。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-450">For a simple Model class, adding a Data Annotation is just handled by adding a **using** statement for **System.ComponentModel.DataAnnotation**, then placing a **[Required]** attribute on the appropriate properties.</span></span> <span data-ttu-id="c8fc7-451">下列範例會使**名稱**屬性在檢視中的必要欄位。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-451">The following example would make the **Name** property a required field in the View.</span></span>

[!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample18.cs)]

<span data-ttu-id="c8fc7-452">這是稍微複雜，就像此應用程式的情況下實體資料模型，產生的位置。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-452">This is a little more complex in cases like this application where the Entity Data Model is generated.</span></span> <span data-ttu-id="c8fc7-453">如果您資料註解直接加入模型類別，它們就會覆寫更新資料庫中的模型。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-453">If you added Data Annotations directly to the model classes, they would be overwritten if you update the model from the database.</span></span> <span data-ttu-id="c8fc7-454">相反地，您可使用它來保存 註解會存在，並與模型相關聯的中繼資料部分類別的類別使用**[MetadataType]**屬性。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-454">Instead, you can make use of metadata partial classes which will exist to hold the annotations and are associated with the model classes using the **[MetadataType]** attribute.</span></span>

1. <span data-ttu-id="c8fc7-455">開啟**開始**方案位於**來源/Ex6AddingValidation/開始/**資料夾。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-455">Open the **Begin** solution located at **Source/Ex6-AddingValidation/Begin/** folder.</span></span> <span data-ttu-id="c8fc7-456">否則，您可能會繼續使用**結束**方案所完成的上一個練習中取得。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-456">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="c8fc7-457">如果您開啟提供**開始**方案，您必須下載某些遺漏的 NuGet 套件才能繼續。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-457">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="c8fc7-458">若要這樣做，請按一下**專案**功能表，然後選取**管理 NuGet 封裝**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-458">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="c8fc7-459">在**管理 NuGet 封裝**] 對話方塊中，按一下 [**還原**才能下載遺漏的封裝。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-459">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="c8fc7-460">最後，按一下 建置方案**建置** | **建置方案**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-460">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="c8fc7-461">使用 NuGet 的優點之一是您不需要在專案中，所有的程式庫的出貨減少專案大小。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-461">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="c8fc7-462">NuGet 的強大工具，請藉由指定封裝版本在 Packages.config 檔案中，您將會成功下載所有必要的程式庫第一次您執行專案。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-462">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="c8fc7-463">這就是為什麼您必須從這個實驗室中開啟現有的方案後執行這些步驟。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-463">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="c8fc7-464">開啟**Album.cs**從**模型**資料夾。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-464">Open the **Album.cs** from the **Models** folder.</span></span>
3. <span data-ttu-id="c8fc7-465">取代**Album.cs**內容以反白顯示的程式碼，使它看起來如下所示：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-465">Replace **Album.cs** content with the highlighted code, so that it looks like the following:</span></span>

    > [!NOTE]
    > <span data-ttu-id="c8fc7-466">線條**[DisplayFormat(ConvertEmptyStringToNull=false)]**代表模型中的空字串不會轉換為 null 的資料來源中更新資料欄位時。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-466">The line **[DisplayFormat(ConvertEmptyStringToNull=false)]** indicates that empty strings from the model won't be converted to null when the data field is updated in the data source.</span></span> <span data-ttu-id="c8fc7-467">Entity Framework 會指派至模型 null 值之前資料註解驗證欄位時，此設定可避免例外狀況。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-467">This setting will avoid an exception when the Entity Framework assigns null values to the model before Data Annotation validates the fields.</span></span>

    <span data-ttu-id="c8fc7-468">(程式碼片段- *ASP.NET MVC 4 Helper 和表單驗證-Ex6 專輯中繼資料的部分類別*)</span><span class="sxs-lookup"><span data-stu-id="c8fc7-468">(Code Snippet - *ASP.NET MVC 4 Helpers and Forms and Validation - Ex6 Album metadata partial class*)</span></span>

    [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample19.cs)]

    > [!NOTE]
    > <span data-ttu-id="c8fc7-469">這**專輯**部分類別具有**MetadataType**屬性指向**AlbumMetaData**資料註解的類別。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-469">This **Album** partial class has a **MetadataType** attribute which points to the **AlbumMetaData** class for the Data Annotations.</span></span> <span data-ttu-id="c8fc7-470">以下是一些您用來標註專輯模型的資料註解屬性：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-470">These are some of the Data Annotation attributes you are using to annotate the Album model:</span></span>
    > 
    > - <span data-ttu-id="c8fc7-471">必要-表示此屬性是必要的欄位</span><span class="sxs-lookup"><span data-stu-id="c8fc7-471">Required - Indicates that the property is a required field</span></span>
    > - <span data-ttu-id="c8fc7-472">DisplayName-定義要用於表單欄位和驗證訊息的文字</span><span class="sxs-lookup"><span data-stu-id="c8fc7-472">DisplayName - Defines the text to be used on form fields and validation messages</span></span>
    > - <span data-ttu-id="c8fc7-473">DisplayFormat-指定資料欄位會顯示並格式化的方式。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-473">DisplayFormat - Specifies how data fields are displayed and formatted.</span></span>
    > - <span data-ttu-id="c8fc7-474">StringLength-定義的字串欄位的最大長度</span><span class="sxs-lookup"><span data-stu-id="c8fc7-474">StringLength - Defines a maximum length for a string field</span></span>
    > - <span data-ttu-id="c8fc7-475">範圍-提供數值欄位的最大和最小值</span><span class="sxs-lookup"><span data-stu-id="c8fc7-475">Range - Gives a maximum and minimum value for a numeric field</span></span>
    > - <span data-ttu-id="c8fc7-476">ScaffoldColumn-可讓隱藏編輯器表單中的欄位</span><span class="sxs-lookup"><span data-stu-id="c8fc7-476">ScaffoldColumn - Allows hiding fields from editor forms</span></span>

<a id="Ex06Task2"></a>

<a id="Task_2_-_Running_the_Application"></a>
#### <a name="task-2---running-the-application"></a><span data-ttu-id="c8fc7-477">工作 2-執行應用程式</span><span class="sxs-lookup"><span data-stu-id="c8fc7-477">Task 2 - Running the Application</span></span>

<span data-ttu-id="c8fc7-478">在這項工作，您將測試建立與編輯頁面驗證欄位，使用最後一個工作中選擇的顯示名稱。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-478">In this task, you will test that the Create and Edit pages validate fields, using the display names chosen in the last task.</span></span>

1. <span data-ttu-id="c8fc7-479">按**F5**執行應用程式。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-479">Press **F5** to run the Application.</span></span>
2. <span data-ttu-id="c8fc7-480">在首頁上，啟動專案。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-480">The project starts in the Home page.</span></span> <span data-ttu-id="c8fc7-481">將 URL 變更為**/StoreManager/建立**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-481">Change the URL to **/StoreManager/Create**.</span></span> <span data-ttu-id="c8fc7-482">確認顯示名稱符合的部分類別中的項目 (例如**專輯封面 URL**而不是**AlbumArtUrl**)</span><span class="sxs-lookup"><span data-stu-id="c8fc7-482">Verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**)</span></span>
3. <span data-ttu-id="c8fc7-483">按一下**建立**，而不填滿表單。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-483">Click **Create**, without filling the form.</span></span> <span data-ttu-id="c8fc7-484">請確認您取得對應的驗證訊息。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-484">Verify that you get the corresponding validation messages.</span></span>

    <span data-ttu-id="c8fc7-485">![驗證 [建立] 頁面中的欄位](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "驗證 [建立] 頁面中的欄位")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-485">![Validated fields in the Create page](aspnet-mvc-4-helpers-forms-and-validation/_static/image18.png "Validated fields in the Create page")</span></span>

    <span data-ttu-id="c8fc7-486">*在 [建立] 頁面中驗證的欄位*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-486">*Validated fields in the Create page*</span></span>
4. <span data-ttu-id="c8fc7-487">您可以確認相同發生**編輯**頁面。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-487">You can verify that the same occurs with the **Edit** page.</span></span> <span data-ttu-id="c8fc7-488">將 URL 變更為**/StoreManager/Edit/1**並確認 顯示名稱符合的部分類別中的項目 (例如**專輯封面 URL**而不是**AlbumArtUrl**)。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-488">Change the URL to **/StoreManager/Edit/1** and verify that the display names match the ones in the partial class (like **Album Art URL** instead of **AlbumArtUrl**).</span></span> <span data-ttu-id="c8fc7-489">空白**標題**和**價格**欄位和按一下**儲存**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-489">Empty the **Title** and **Price** fields and click **Save**.</span></span> <span data-ttu-id="c8fc7-490">請確認您取得對應的驗證訊息。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-490">Verify that you get the corresponding validation messages.</span></span>

    ![驗證的欄位中編輯頁面](aspnet-mvc-4-helpers-forms-and-validation/_static/image19.png)

    <span data-ttu-id="c8fc7-492">*驗證的欄位中編輯頁面*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-492">*Validated fields in the Edit page*</span></span>

<a id="Exercise7"></a>

<a id="Exercise_7_Using_Unobtrusive_jQuery_at_Client_Side"></a>
### <a name="exercise-7-using-unobtrusive-jquery-at-client-side"></a><span data-ttu-id="c8fc7-493">練習 7： 在用戶端使用不顯眼的 jQuery</span><span class="sxs-lookup"><span data-stu-id="c8fc7-493">Exercise 7: Using Unobtrusive jQuery at Client Side</span></span>

<span data-ttu-id="c8fc7-494">在此練習中，您將學習如何啟用 MVC 4 不顯眼的 jQuery 驗證用戶端。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-494">In this exercise, you will learn how to enable MVC 4 Unobtrusive jQuery validation at client side.</span></span>

> [!NOTE]
> <span data-ttu-id="c8fc7-495">不顯眼的 jQuery 會使用資料 ajax 首碼 JavaScript 來叫用伺服器，而非 intrusively 發出內嵌用戶端指令碼的動作方法。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-495">The Unobtrusive jQuery uses data-ajax prefix JavaScript to invoke action methods on the server rather than intrusively emitting inline client scripts.</span></span>


<a id="Ex7Task1"></a>

<a id="Task_1_-_Running_the_Application_before_Enabling_Unobtrusive_jQuery"></a>
#### <a name="task-1---running-the-application-before-enabling-unobtrusive-jquery"></a><span data-ttu-id="c8fc7-496">工作 1-執行之前啟用不顯眼的 jQuery 應用程式</span><span class="sxs-lookup"><span data-stu-id="c8fc7-496">Task 1 - Running the Application before Enabling Unobtrusive jQuery</span></span>

<span data-ttu-id="c8fc7-497">在這個工作中，您將執行的應用程式，才能包括 jQuery 才能比較這兩種驗證模式。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-497">In this task, you will run the application before including jQuery in order to compare both validation models.</span></span>

1. <span data-ttu-id="c8fc7-498">開啟**開始**方案位於**來源/Ex7UnobtrusivejQueryValidation/開始/**資料夾。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-498">Open the **Begin** solution located at **Source/Ex7-UnobtrusivejQueryValidation/Begin/** folder.</span></span> <span data-ttu-id="c8fc7-499">否則，您可能會繼續使用**結束**方案所完成的上一個練習中取得。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-499">Otherwise, you might continue using the **End** solution obtained by completing the previous exercise.</span></span>

   1. <span data-ttu-id="c8fc7-500">如果您開啟提供**開始**方案，您必須下載某些遺漏的 NuGet 套件才能繼續。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-500">If you opened the provided **Begin** solution, you will need to download some missing NuGet packages before continue.</span></span> <span data-ttu-id="c8fc7-501">若要這樣做，請按一下**專案**功能表，然後選取**管理 NuGet 封裝**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-501">To do this, click the **Project** menu and select **Manage NuGet Packages**.</span></span>
   2. <span data-ttu-id="c8fc7-502">在**管理 NuGet 封裝**] 對話方塊中，按一下 [**還原**才能下載遺漏的封裝。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-502">In the **Manage NuGet Packages** dialog, click **Restore** in order to download missing packages.</span></span>
   3. <span data-ttu-id="c8fc7-503">最後，按一下 建置方案**建置** | **建置方案**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-503">Finally, build the solution by clicking **Build** | **Build Solution**.</span></span>

      > [!NOTE]
      > <span data-ttu-id="c8fc7-504">使用 NuGet 的優點之一是您不需要在專案中，所有的程式庫的出貨減少專案大小。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-504">One of the advantages of using NuGet is that you don't have to ship all the libraries in your project, reducing the project size.</span></span> <span data-ttu-id="c8fc7-505">NuGet 的強大工具，請藉由指定封裝版本在 Packages.config 檔案中，您將會成功下載所有必要的程式庫第一次您執行專案。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-505">With NuGet Power Tools, by specifying the package versions in the Packages.config file, you will be able to download all the required libraries the first time you run the project.</span></span> <span data-ttu-id="c8fc7-506">這就是為什麼您必須從這個實驗室中開啟現有的方案後執行這些步驟。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-506">This is why you will have to run these steps after you open an existing solution from this lab.</span></span>
2. <span data-ttu-id="c8fc7-507">按 **F5** 執行應用程式。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-507">Press **F5** to run the application.</span></span>
3. <span data-ttu-id="c8fc7-508">在首頁上，啟動專案。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-508">The project starts in the Home page.</span></span> <span data-ttu-id="c8fc7-509">瀏覽**/StoreManager/建立**按一下**建立**沒有填滿表單，以確認您看到驗證訊息：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-509">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="c8fc7-510">![停用用戶端驗證](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "停用用戶端驗證")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-510">![Client validation disabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image20.png "Client validation disabled")</span></span>

    <span data-ttu-id="c8fc7-511">*停用用戶端驗證*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-511">*Client validation disabled*</span></span>
4. <span data-ttu-id="c8fc7-512">在瀏覽器中開啟 HTML 程式碼：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-512">In the browser, open the HTML source code:</span></span>
...
#### <a name="task-2---enabling-unobtrusive-client-validation"></a><span data-ttu-id="c8fc7-513">工作 2-啟用不顯眼的用戶端驗證</span><span class="sxs-lookup"><span data-stu-id="c8fc7-513">Task 2 - Enabling Unobtrusive Client Validation</span></span>

<span data-ttu-id="c8fc7-514">在這個工作中，您將啟用 jQuery**不顯眼的用戶端驗證**從**Web.config**檔案，也就是預設值為 false，所有新的 ASP.NET MVC 4 專案中。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-514">In this task, you will enable jQuery **unobtrusive client validation** from **Web.config** file, which is by default set to false in all new ASP.NET MVC 4 projects.</span></span> <span data-ttu-id="c8fc7-515">此外，您會加入必要的指令碼進行 jQuery 不顯眼的用戶端驗證工作的參考。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-515">Additionally, you will add the necessary scripts references to make jQuery Unobtrusive Client Validation work.</span></span>

1. <span data-ttu-id="c8fc7-516">開啟**Web.Config**檔案在專案的根目錄，並確定**ClientValidationEnabled**和**UnobtrusiveJavaScriptEnabled**金鑰值都會設為**true**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-516">Open **Web.Config** file at project root, and make sure that the **ClientValidationEnabled** and **UnobtrusiveJavaScriptEnabled** keys values are set to **true**.</span></span>

    [!code-xml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample21.xml)]

    > [!NOTE]
    > <span data-ttu-id="c8fc7-517">您也可以啟用用戶端驗證的程式碼中 Global.asax.cs 以取得相同的結果：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-517">You can also enable client validation by code at Global.asax.cs to get the same results:</span></span>
    > 
    > <span data-ttu-id="c8fc7-518">**HtmlHelper.ClientValidationEnabled = true;**</span><span class="sxs-lookup"><span data-stu-id="c8fc7-518">**HtmlHelper.ClientValidationEnabled = true;**</span></span>
    > 
    > <span data-ttu-id="c8fc7-519">此外，您可以指派 ClientValidationEnabled 屬性到任何控制器有自訂的行為。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-519">Additionally, you can assign ClientValidationEnabled attribute into any controller to have a custom behavior.</span></span>
2. <span data-ttu-id="c8fc7-520">開啟**Create.cshtml**在**Views\StoreManager**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-520">Open **Create.cshtml** at **Views\StoreManager**.</span></span>
3. <span data-ttu-id="c8fc7-521">下列指令碼檔案，請確定**jquery.validate**和**jquery.validate.unobtrusive**，都會在檢視透過&quot; **~/bundles/jqueryval**&quot;組合。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-521">Make sure the following script files, **jquery.validate** and **jquery.validate.unobtrusive**, are referenced in the view throught the &quot;**~/bundles/jqueryval**&quot; bundle.</span></span>

    [!code-cshtml[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample22.cshtml)]

    > [!NOTE]
    > <span data-ttu-id="c8fc7-522">所有這些 jQuery 程式庫會包含在新的 MVC 4 專案。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-522">All these jQuery libraries are included in MVC 4 new projects.</span></span> <span data-ttu-id="c8fc7-523">您可以找到更多程式庫中的**/指令碼**您專案的資料夾。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-523">You can find more libraries in the **/Scripts** folder of you project.</span></span>
    > 
    > <span data-ttu-id="c8fc7-524">若要讓這項驗證程式庫工作，您需要加入 jQuery framework 程式庫的參考。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-524">In order to make this validation libraries work, you need to add a reference to the jQuery framework library.</span></span> <span data-ttu-id="c8fc7-525">因為中已加入此參考 **\_Layout.cshtml**檔案中，您不需要將它加入這個特定的檢視中。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-525">Since this reference is already added in the **\_Layout.cshtml** file, you do not need to add it in this particular view.</span></span>

<a id="Ex7Task3"></a>

<a id="Task_3_-_Running_the_Application_Using_Unobtrusive_jQuery_Validation"></a>
#### <a name="task-3---running-the-application-using-unobtrusive-jquery-validation"></a><span data-ttu-id="c8fc7-526">工作 3-執行應用程式使用不顯眼的 jQuery 驗證</span><span class="sxs-lookup"><span data-stu-id="c8fc7-526">Task 3 - Running the Application Using Unobtrusive jQuery Validation</span></span>

<span data-ttu-id="c8fc7-527">在這個工作中，您將測試的**StoreManager**建立範本執行的用戶端驗證使用 jQuery 程式庫，當使用者建立新的相簿的檢視。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-527">In this task, you will test that the **StoreManager** create view template performs client side validation using jQuery libraries when the user creates a new album.</span></span>

1. <span data-ttu-id="c8fc7-528">按 **F5** 執行應用程式。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-528">Press **F5** to run the application.</span></span>
2. <span data-ttu-id="c8fc7-529">在首頁上，啟動專案。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-529">The project starts in the Home page.</span></span> <span data-ttu-id="c8fc7-530">瀏覽**/StoreManager/建立**按一下**建立**沒有填滿表單，以確認您看到驗證訊息：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-530">Browse **/StoreManager/Create** and click **Create** without filling the form to verify that you get validation messages:</span></span>

    <span data-ttu-id="c8fc7-531">![使用 jQuery 啟用的用戶端驗證](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "jQuery 啟用與用戶端驗證")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-531">![Client validation with jQuery enabled](aspnet-mvc-4-helpers-forms-and-validation/_static/image21.png "Client validation with jQuery enabled")</span></span>

    <span data-ttu-id="c8fc7-532">*使用 jQuery 啟用的用戶端驗證*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-532">*Client validation with jQuery enabled*</span></span>
3. <span data-ttu-id="c8fc7-533">在瀏覽器中開啟 建立檢視的程式碼：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-533">In the browser, open the source code for Create view:</span></span>

    [!code-html[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample23.html)]

   > [!NOTE]
   > <span data-ttu-id="c8fc7-534">每個用戶端驗證規則不顯眼的 jQuery 加入資料屬性-val-*rulename*=&quot;*訊息*&quot;。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-534">For each client validation rule, Unobtrusive jQuery adds an attribute with data-val-*rulename*=&quot;*message*&quot;.</span></span> <span data-ttu-id="c8fc7-535">以下是一份標記該 Unobtrusive jQuery 插入 html 輸入欄位，以執行用戶端驗證：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-535">Below is a list of tags that Unobtrusive jQuery inserts into the html input field to perform client validation:</span></span>
   > 
   > - <span data-ttu-id="c8fc7-536">資料值</span><span class="sxs-lookup"><span data-stu-id="c8fc7-536">Data-val</span></span>
   > - <span data-ttu-id="c8fc7-537">Data-val-number</span><span class="sxs-lookup"><span data-stu-id="c8fc7-537">Data-val-number</span></span>
   > - <span data-ttu-id="c8fc7-538">資料 val 範圍</span><span class="sxs-lookup"><span data-stu-id="c8fc7-538">Data-val-range</span></span>
   > - <span data-ttu-id="c8fc7-539">資料 val 範圍-min/資料 val-range max</span><span class="sxs-lookup"><span data-stu-id="c8fc7-539">Data-val-range-min / Data-val-range-max</span></span>
   > - <span data-ttu-id="c8fc7-540">Data-val-required</span><span class="sxs-lookup"><span data-stu-id="c8fc7-540">Data-val-required</span></span>
   > - <span data-ttu-id="c8fc7-541">資料 val 長度</span><span class="sxs-lookup"><span data-stu-id="c8fc7-541">Data-val-length</span></span>
   > - <span data-ttu-id="c8fc7-542">資料值的長度上限/資料 val 長度-分鐘</span><span class="sxs-lookup"><span data-stu-id="c8fc7-542">Data-val-length-max / Data-val-length-min</span></span>
   > 
   > <span data-ttu-id="c8fc7-543">所有的資料值會填入模型**資料註解**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-543">All the data values are filled with model **Data Annotation**.</span></span> <span data-ttu-id="c8fc7-544">然後，在伺服器端的所有邏輯可以都執行用戶端。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-544">Then, all the logic that works at server side can be run at client side.</span></span> <span data-ttu-id="c8fc7-545">例如，價格屬性都具有下列資料註解模型中：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-545">For example, Price attribute has the following data annotation in the model:</span></span>
   > 
   > [!code-csharp[Main](aspnet-mvc-4-helpers-forms-and-validation/samples/sample24.cs)]
   > 
   > <span data-ttu-id="c8fc7-546">使用不顯眼的 jQuery 之後, 產生的程式碼是：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-546">After using Unobtrusive jQuery, the generated code is:</span></span>
   > 
...
<a id="Summary"></a>
## <a name="summary"></a><span data-ttu-id="c8fc7-547">總結</span><span class="sxs-lookup"><span data-stu-id="c8fc7-547">Summary</span></span>

<span data-ttu-id="c8fc7-548">藉由完成這個實際操作實驗室中，您已經學會如何讓使用者變更儲存在資料庫中使用下列資料：</span><span class="sxs-lookup"><span data-stu-id="c8fc7-548">By completing this Hands-On Lab you have learned how to enable users to change the data stored in the database with the use of the following:</span></span>

- <span data-ttu-id="c8fc7-549">控制器動作，例如索引，建立、 編輯、 刪除</span><span class="sxs-lookup"><span data-stu-id="c8fc7-549">Controller actions like Index, Create, Edit, Delete</span></span>
- <span data-ttu-id="c8fc7-550">ASP.NET MVC 的 scaffolding 功能 HTML 表格中顯示屬性</span><span class="sxs-lookup"><span data-stu-id="c8fc7-550">ASP.NET MVC's scaffolding feature for displaying properties in an HTML table</span></span>
- <span data-ttu-id="c8fc7-551">自訂 HTML helper 來改善使用者體驗</span><span class="sxs-lookup"><span data-stu-id="c8fc7-551">Custom HTML helpers to improve user experience</span></span>
- <span data-ttu-id="c8fc7-552">回應 HTTP GET 或 HTTP POST 呼叫的動作方法</span><span class="sxs-lookup"><span data-stu-id="c8fc7-552">Action methods that react to either HTTP-GET or HTTP-POST calls</span></span>
- <span data-ttu-id="c8fc7-553">類似的檢視範本，例如建立與編輯共用的編輯器範本</span><span class="sxs-lookup"><span data-stu-id="c8fc7-553">A shared editor template for similar View templates like Create and Edit</span></span>
- <span data-ttu-id="c8fc7-554">下拉式清單類似的表單項目</span><span class="sxs-lookup"><span data-stu-id="c8fc7-554">Form elements like drop-downs</span></span>
- <span data-ttu-id="c8fc7-555">模型驗證的資料註解</span><span class="sxs-lookup"><span data-stu-id="c8fc7-555">Data annotations for Model validation</span></span>
- <span data-ttu-id="c8fc7-556">使用 jQuery 不顯眼的程式庫的用戶端驗證</span><span class="sxs-lookup"><span data-stu-id="c8fc7-556">Client Side Validation using jQuery Unobtrusive library</span></span>

<a id="AppendixA"></a>

<a id="Appendix_A_Installing_Visual_Studio_Express_2012_for_Web"></a>
## <a name="appendix-a-installing-visual-studio-express-2012-for-web"></a><span data-ttu-id="c8fc7-557">附錄 a： 安裝 Visual Studio Express 2012 for Web</span><span class="sxs-lookup"><span data-stu-id="c8fc7-557">Appendix A: Installing Visual Studio Express 2012 for Web</span></span>

<span data-ttu-id="c8fc7-558">您可以安裝**Microsoft Visual Studio Express 2012 for Web**或另一個&quot;Express&quot;版本使用**[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span><span class="sxs-lookup"><span data-stu-id="c8fc7-558">You can install **Microsoft Visual Studio Express 2012 for Web** or another &quot;Express&quot; version using the **[Microsoft Web Platform Installer](https://www.microsoft.com/web/downloads/platform.aspx)**.</span></span> <span data-ttu-id="c8fc7-559">下列指示將引導您逐步完成安裝所需*Visual studio Express 2012 for Web*使用*Microsoft Web Platform Installer*。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-559">The following instructions guide you through the steps required to install *Visual studio Express 2012 for Web* using *Microsoft Web Platform Installer*.</span></span>

1. <span data-ttu-id="c8fc7-560">移至[ [ https://go.microsoft.com/?linkid=9810169 ](https://go.microsoft.com/?linkid=9810169) ](https://go.microsoft.com/?linkid=9810169)。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-560">Go to [[https://go.microsoft.com/?linkid=9810169](https://go.microsoft.com/?linkid=9810169)](https://go.microsoft.com/?linkid=9810169).</span></span> <span data-ttu-id="c8fc7-561">或者，如果您已安裝 Web Platform Installer，您可以開啟它，並搜尋產品&quot; <em>Visual Studio Express 2012 for Web 與 Windows Azure SDK</em>&quot;。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-561">Alternatively, if you already have installed Web Platform Installer, you can open it and search for the product &quot;<em>Visual Studio Express 2012 for Web with Windows Azure SDK</em>&quot;.</span></span>
2. <span data-ttu-id="c8fc7-562">按一下**立即安裝**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-562">Click on **Install Now**.</span></span> <span data-ttu-id="c8fc7-563">如果您不需要**Web Platform Installer**您會重新導向至下載並安裝第一次。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-563">If you do not have **Web Platform Installer** you will be redirected to download and install it first.</span></span>
3. <span data-ttu-id="c8fc7-564">一次**Web Platform Installer**開啟時，按一下 **安裝**，啟動安裝程式。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-564">Once **Web Platform Installer** is open, click **Install** to start the setup.</span></span>

    <span data-ttu-id="c8fc7-565">![安裝 Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "安裝 Visual Studio Express")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-565">![Install Visual Studio Express](aspnet-mvc-4-helpers-forms-and-validation/_static/image22.png "Install Visual Studio Express")</span></span>

    <span data-ttu-id="c8fc7-566">*安裝 Visual Studio Express*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-566">*Install Visual Studio Express*</span></span>
4. <span data-ttu-id="c8fc7-567">閱讀所有產品的授權和詞彙，然後按一下**我接受**才能繼續。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-567">Read all the products' licenses and terms and click **I Accept** to continue.</span></span>

    ![接受授權條款](aspnet-mvc-4-helpers-forms-and-validation/_static/image23.png)

    <span data-ttu-id="c8fc7-569">*接受授權條款*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-569">*Accepting the license terms*</span></span>
5. <span data-ttu-id="c8fc7-570">等待直到完成下載和安裝程序。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-570">Wait until the downloading and installation process completes.</span></span>

    ![安裝進度](aspnet-mvc-4-helpers-forms-and-validation/_static/image24.png)

    <span data-ttu-id="c8fc7-572">*安裝進度*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-572">*Installation progress*</span></span>
6. <span data-ttu-id="c8fc7-573">當安裝完成時，按一下**完成**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-573">When the installation completes, click **Finish**.</span></span>

    ![安裝已完成](aspnet-mvc-4-helpers-forms-and-validation/_static/image25.png)

    <span data-ttu-id="c8fc7-575">*安裝已完成*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-575">*Installation completed*</span></span>
7. <span data-ttu-id="c8fc7-576">按一下**結束**關閉 Web Platform Installer。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-576">Click **Exit** to close Web Platform Installer.</span></span>
8. <span data-ttu-id="c8fc7-577">若要開啟 Visual Studio Express for Web，請移至**啟動**畫面上，並開始書寫&quot; **VS Express**&quot;，然後按一下  **VS Express for Web**並排顯示。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-577">To open Visual Studio Express for Web, go to the **Start** screen and start writing &quot;**VS Express**&quot;, then click on the **VS Express for Web** tile.</span></span>

    ![VS Express for Web 方塊](aspnet-mvc-4-helpers-forms-and-validation/_static/image26.png)

    <span data-ttu-id="c8fc7-579">*VS Express for Web 方塊*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-579">*VS Express for Web tile*</span></span>

<a id="AppendixB"></a>

<a id="Appendix_B_Using_Code_Snippets"></a>
## <a name="appendix-b-using-code-snippets"></a><span data-ttu-id="c8fc7-580">附錄 b： 使用程式碼片段</span><span class="sxs-lookup"><span data-stu-id="c8fc7-580">Appendix B: Using Code Snippets</span></span>

<span data-ttu-id="c8fc7-581">程式碼片段，您會有您需要在您可以的所有程式碼。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-581">With code snippets, you have all the code you need at your fingertips.</span></span> <span data-ttu-id="c8fc7-582">實驗室文件會告訴您完全時您可以使用它們，如下圖所示。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-582">The lab document will tell you exactly when you can use them, as shown in the following figure.</span></span>

<span data-ttu-id="c8fc7-583">![若要將程式碼插入您的專案中使用 Visual Studio 程式碼片段](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "使用 Visual Studio 程式碼片段，將程式碼插入您的專案")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-583">![Using Visual Studio code snippets to insert code into your project](aspnet-mvc-4-helpers-forms-and-validation/_static/image27.png "Using Visual Studio code snippets to insert code into your project")</span></span>

<span data-ttu-id="c8fc7-584">*若要將程式碼插入您的專案中使用 Visual Studio 程式碼片段*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-584">*Using Visual Studio code snippets to insert code into your project*</span></span>

<span data-ttu-id="c8fc7-585">***若要加入的程式碼片段，使用鍵盤 （僅限 C#)***</span><span class="sxs-lookup"><span data-stu-id="c8fc7-585">***To add a code snippet using the keyboard (C# only)***</span></span>

1. <span data-ttu-id="c8fc7-586">將游標放在您想要插入的程式碼。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-586">Place the cursor where you would like to insert the code.</span></span>
2. <span data-ttu-id="c8fc7-587">開始鍵入片段名稱 （不含空格或連字號）。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-587">Start typing the snippet name (without spaces or hyphens).</span></span>
3. <span data-ttu-id="c8fc7-588">觀察 IntelliSense 會顯示比對程式碼片段的名稱。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-588">Watch as IntelliSense displays matching snippets' names.</span></span>
4. <span data-ttu-id="c8fc7-589">選取正確的程式碼片段 （或直到選取整個程式碼片段名稱時，保留 輸入）。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-589">Select the correct snippet (or keep typing until the entire snippet's name is selected).</span></span>
5. <span data-ttu-id="c8fc7-590">按下 Tab 鍵兩次的游標位置插入程式碼片段。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-590">Press the Tab key twice to insert the snippet at the cursor location.</span></span>

<span data-ttu-id="c8fc7-591">![開始輸入程式碼片段名稱](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "開始鍵入片段名稱")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-591">![Start typing the snippet name](aspnet-mvc-4-helpers-forms-and-validation/_static/image28.png "Start typing the snippet name")</span></span>

<span data-ttu-id="c8fc7-592">*開始輸入程式碼片段名稱*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-592">*Start typing the snippet name*</span></span>

<span data-ttu-id="c8fc7-593">![按 Tab 鍵選取反白顯示的程式碼片段](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "按 Tab 鍵以選取反白顯示的程式碼片段")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-593">![Press Tab to select the highlighted snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image29.png "Press Tab to select the highlighted snippet")</span></span>

<span data-ttu-id="c8fc7-594">*按 Tab 鍵選取反白顯示的程式碼片段*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-594">*Press Tab to select the highlighted snippet*</span></span>

<span data-ttu-id="c8fc7-595">![按 Tab 鍵一次程式碼片段就會擴展](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "按 Tab 鍵一次程式碼片段就會擴展")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-595">![Press Tab again and the snippet will expand](aspnet-mvc-4-helpers-forms-and-validation/_static/image30.png "Press Tab again and the snippet will expand")</span></span>

<span data-ttu-id="c8fc7-596">*按 Tab 鍵一次程式碼片段就會擴展*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-596">*Press Tab again and the snippet will expand*</span></span>

<span data-ttu-id="c8fc7-597">***若要加入的程式碼片段，使用滑鼠 （C#、 Visual Basic 和 XML）*** 1。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-597">***To add a code snippet using the mouse (C#, Visual Basic and XML)*** 1.</span></span> <span data-ttu-id="c8fc7-598">以滑鼠右鍵按一下您要插入程式碼片段。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-598">Right-click where you want to insert the code snippet.</span></span>

1. <span data-ttu-id="c8fc7-599">選取**插入程式碼片段**後面**我的程式碼片段**。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-599">Select **Insert Snippet** followed by **My Code Snippets**.</span></span>
2. <span data-ttu-id="c8fc7-600">透過在按一下挑選清單中，從相關的程式碼片段。</span><span class="sxs-lookup"><span data-stu-id="c8fc7-600">Pick the relevant snippet from the list, by clicking on it.</span></span>

<span data-ttu-id="c8fc7-601">![以滑鼠右鍵按一下您要插入程式碼片段，然後選取 插入程式碼片段](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "以滑鼠右鍵按一下您要插入程式碼片段，然後選取 插入程式碼片段")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-601">![Right-click where you want to insert the code snippet and select Insert Snippet](aspnet-mvc-4-helpers-forms-and-validation/_static/image31.png "Right-click where you want to insert the code snippet and select Insert Snippet")</span></span>

<span data-ttu-id="c8fc7-602">*以滑鼠右鍵按一下您要插入程式碼片段，然後選取 插入程式碼片段*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-602">*Right-click where you want to insert the code snippet and select Insert Snippet*</span></span>

<span data-ttu-id="c8fc7-603">![透過在按一下挑選清單中，從相關的程式碼片段](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "上它即可挑選清單中，從相關的程式碼片段")</span><span class="sxs-lookup"><span data-stu-id="c8fc7-603">![Pick the relevant snippet from the list, by clicking on it](aspnet-mvc-4-helpers-forms-and-validation/_static/image32.png "Pick the relevant snippet from the list, by clicking on it")</span></span>

<span data-ttu-id="c8fc7-604">*透過在按一下挑選清單中，從相關的程式碼片段*</span><span class="sxs-lookup"><span data-stu-id="c8fc7-604">*Pick the relevant snippet from the list, by clicking on it*</span></span>
