...
如果您的應用程式使用先前使用[AspNetCore](xref:web-api/advanced/analyzers)所發行的[api 分析器](https://www.nuget.org/packages/Microsoft.AspNetCore.Mvc.Api.Analyzers/)，請編輯您的專案檔，以參考 .NET Core Web SDK 隨附的分析器：
