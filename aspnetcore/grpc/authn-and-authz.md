...
---
# <a name="authentication-and-authorization-in-grpc-for-aspnet-core"></a>Authentication and authorization in gRPC for ASP.NET Core
...
## <a name="authenticate-users-calling-a-grpc-service"></a>Authenticate users calling a gRPC service
...
### <a name="other-authentication-mechanisms"></a>Other authentication mechanisms
...
## <a name="authorize-users-to-access-services-and-service-methods"></a>Authorize users to access services and service methods
