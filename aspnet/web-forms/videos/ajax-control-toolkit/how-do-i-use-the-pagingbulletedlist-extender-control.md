...
這段影片示範如何從 ASP.NET AJAX Control Toolkit PagingBulletedList 擴充項控制項使用。 我們了解用戶端分頁和排序的標準 ASP.NET BulletedList，控制項中呈現的項目延伸清單時，可大幅提升使用者體驗、 PagingBulletedList 擴充項新增的方式。 我們也會看到我們可以如何定義自訂的 JavaScript 及 CSS 來完全管理的使用者體驗。
