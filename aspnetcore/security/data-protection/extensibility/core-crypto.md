...
>[!TIP]
> 有一個 helper API 可用於設定此屬性。 呼叫位於命名空間 Microsoft.AspNetCore.DataProtection.AuthenticatedEncryption.ConfigurationModel 中的擴充方法 System.xml.linq.xelement>. MarkAsRequiresEncryption （）。
