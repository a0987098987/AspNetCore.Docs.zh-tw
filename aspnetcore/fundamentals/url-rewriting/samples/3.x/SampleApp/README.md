# <a name="aspnet-core-url-rewriting-sample"></a><span data-ttu-id="d9800-101">ASP.NET Core URL 重寫範例</span><span class="sxs-lookup"><span data-stu-id="d9800-101">ASP.NET Core URL Rewriting Sample</span></span>
