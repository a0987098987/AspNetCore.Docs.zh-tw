...
ms.locfileid: "41830777"
---
<a name="aspnet-web-forms-and-ajax-452"></a><span data-ttu-id="43465-102">ASP.NET Web Form 和 Ajax 4.5.2</span><span class="sxs-lookup"><span data-stu-id="43465-102">ASP.NET Web Forms and Ajax 4.5.2</span></span>
====================
<span data-ttu-id="43465-103">下列檔案裝載在 CDN 上：</span><span class="sxs-lookup"><span data-stu-id="43465-103">The following files are hosted on the CDN:</span></span>
...
<span data-ttu-id="43465-104">注意： 全球化指令碼，例如 fr FR.js，可在下列資料夾：</span><span class="sxs-lookup"><span data-stu-id="43465-104">Note: The globalization scripts, such as fr-FR.js, can be found in the following folder:</span></span>
