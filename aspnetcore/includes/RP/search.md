# <a name="adding-search-to-a-razor-pages-app"></a><span data-ttu-id="c7607-101">新增搜尋至 Razor 頁面應用程式</span><span class="sxs-lookup"><span data-stu-id="c7607-101">Adding search to a Razor Pages app</span></span>
